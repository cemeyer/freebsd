...
struct linux_waitpid_args {
	...
	char status_l_[PADL_(l_int *)]; l_int __user * status; char status_r_[PADR_(l_int *)];
...
struct linux_link_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char to_l_[PADL_(char *)]; char __user * to; char to_r_[PADR_(char *)];
};
...
struct linux_execve_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char argp_l_[PADL_(char **)]; char __user * __user * argp; char argp_r_[PADR_(char **)];
	char envp_l_[PADL_(char **)]; char __user * __user * envp; char envp_r_[PADR_(char **)];
};
struct linux_chdir_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
};
struct linux_time_args {
	char tm_l_[PADL_(l_time_t *)]; l_time_t __user * tm; char tm_r_[PADR_(l_time_t *)];
};
...
struct linux_stat_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char up_l_[PADL_(struct linux_stat *)]; struct linux_stat __user * up; char up_r_[PADR_(struct linux_stat *)];
};
...
struct linux_mount_args {
	char specialfile_l_[PADL_(char *)]; char __user * specialfile; char specialfile_r_[PADR_(char *)];
	char dir_l_[PADL_(char *)]; char __user * dir; char dir_r_[PADR_(char *)];
	char filesystemtype_l_[PADL_(char *)]; char __user * filesystemtype; char filesystemtype_r_[PADR_(char *)];
...
struct linux_utime_args {
	char fname_l_[PADL_(char *)]; char __user * fname; char fname_r_[PADR_(char *)];
	char times_l_[PADL_(struct l_utimbuf *)]; struct l_utimbuf __user * times; char times_r_[PADR_(struct l_utimbuf *)];
};
...
struct linux_rename_args {
	char from_l_[PADL_(char *)]; char __user * from; char from_r_[PADR_(char *)];
	char to_l_[PADL_(char *)]; char __user * to; char to_r_[PADR_(char *)];
};
...
struct linux_pipe_args {
	char pipefds_l_[PADL_(l_int *)]; l_int __user * pipefds; char pipefds_r_[PADR_(l_int *)];
};
struct linux_times_args {
	char buf_l_[PADL_(struct l_times_argv *)]; struct l_times_argv __user * buf; char buf_r_[PADR_(struct l_times_argv *)];
};
...
struct linux_signal_args {
	...
	char handler_l_[PADL_(void *)]; void __user * handler; char handler_r_[PADR_(void *)];
};
...
struct linux_ustat_args {
	char dev_l_[PADL_(l_dev_t)]; l_dev_t dev; char dev_r_[PADR_(l_dev_t)];
	char ubuf_l_[PADL_(struct l_ustat *)]; struct l_ustat __user * ubuf; char ubuf_r_[PADR_(struct l_ustat *)];
};
...
struct linux_sigaction_args {
	char sig_l_[PADL_(l_int)]; l_int sig; char sig_r_[PADR_(l_int)];
	char nsa_l_[PADL_(l_osigaction_t *)]; l_osigaction_t __user * nsa; char nsa_r_[PADR_(l_osigaction_t *)];
	char osa_l_[PADL_(l_osigaction_t *)]; l_osigaction_t __user * osa; char osa_r_[PADR_(l_osigaction_t *)];
};
...
struct linux_sigpending_args {
	char mask_l_[PADL_(l_osigset_t *)]; l_osigset_t __user * mask; char mask_r_[PADR_(l_osigset_t *)];
};
...
struct linux_setrlimit_args {
	...
	char rlim_l_[PADL_(struct l_rlimit *)]; struct l_rlimit __user * rlim; char rlim_r_[PADR_(struct l_rlimit *)];
};
...
struct linux_getgroups16_args {
	...
	char gidset_l_[PADL_(l_gid16_t *)]; l_gid16_t __user * gidset; char gidset_r_[PADR_(l_gid16_t *)];
};
...
struct linux_old_select_args {
	char ptr_l_[PADL_(struct l_old_select_argv *)]; struct l_old_select_argv __user * ptr; char ptr_r_[PADR_(struct l_old_select_argv *)];
};
...
struct linux_lstat_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char up_l_[PADL_(struct l_stat *)]; struct l_stat __user * up; char up_r_[PADR_(struct l_stat *)];
};
struct linux_readlink_args {
	char name_l_[PADL_(char *)]; char __user * name; char name_r_[PADR_(char *)];
...
struct linux_uselib_args {
	char library_l_[PADL_(char *)]; char __user * library; char library_r_[PADR_(char *)];
};
...
struct linux_readdir_args {
	char fd_l_[PADL_(l_uint)]; l_uint fd; char fd_r_[PADR_(l_uint)];
	char dent_l_[PADL_(struct l_dirent *)]; struct l_dirent __user * dent; char dent_r_[PADR_(struct l_dirent *)];
	char count_l_[PADL_(l_uint)]; l_uint count; char count_r_[PADR_(l_uint)];
};
struct linux_mmap_args {
	char ptr_l_[PADL_(struct l_mmap_argv *)]; struct l_mmap_argv __user * ptr; char ptr_r_[PADR_(struct l_mmap_argv *)];
};
...
struct linux_statfs_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char buf_l_[PADL_(struct l_statfs_buf *)]; struct l_statfs_buf __user * buf; char buf_r_[PADR_(struct l_statfs_buf *)];
};
...
struct linux_setitimer_args {
	...
	char itv_l_[PADL_(struct l_itimerval *)]; struct l_itimerval __user * itv; char itv_r_[PADR_(struct l_itimerval *)];
	char oitv_l_[PADL_(struct l_itimerval *)]; struct l_itimerval __user * oitv; char oitv_r_[PADR_(struct l_itimerval *)];
};
...
struct linux_newstat_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char buf_l_[PADL_(struct l_newstat *)]; struct l_newstat __user * buf; char buf_r_[PADR_(struct l_newstat *)];
};
...
struct linux_wait4_args {
	...
	char status_l_[PADL_(l_int *)]; l_int __user * status; char status_r_[PADR_(l_int *)];
	char options_l_[PADL_(l_int)]; l_int options; char options_r_[PADR_(l_int)];
	char rusage_l_[PADL_(void *)]; void __user * rusage; char rusage_r_[PADR_(void *)];
};
struct linux_swapoff_args {
	register_t dummy;
};
struct linux_sysinfo_args {
	char info_l_[PADL_(struct l_sysinfo *)]; struct l_sysinfo __user * info; char info_r_[PADR_(struct l_sysinfo *)];
};
...
struct linux_sigreturn_args {
	char sfp_l_[PADL_(struct l_sigframe *)]; struct l_sigframe __user * sfp; char sfp_r_[PADR_(struct l_sigframe *)];
};
struct linux_clone_args {
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
	char stack_l_[PADL_(void *)]; void __user * stack; char stack_r_[PADR_(void *)];
	char parent_tidptr_l_[PADL_(void *)]; void __user * parent_tidptr; char parent_tidptr_r_[PADR_(void *)];
	char tls_l_[PADL_(void *)]; void __user * tls; char tls_r_[PADR_(void *)];
	char child_tidptr_l_[PADL_(void *)]; void __user * child_tidptr; char child_tidptr_r_[PADR_(void *)];
};
...
struct linux_newuname_args {
	char buf_l_[PADL_(struct l_new_utsname *)]; struct l_new_utsname __user * buf; char buf_r_[PADR_(struct l_new_utsname *)];
};
struct linux_modify_ldt_args {
	char func_l_[PADL_(l_int)]; l_int func; char func_r_[PADR_(l_int)];
	char ptr_l_[PADL_(void *)]; void __user * ptr; char ptr_r_[PADR_(void *)];
...
struct linux_sigprocmask_args {
	...
	char mask_l_[PADL_(l_osigset_t *)]; l_osigset_t __user * mask; char mask_r_[PADR_(l_osigset_t *)];
	char omask_l_[PADL_(l_osigset_t *)]; l_osigset_t __user * omask; char omask_r_[PADR_(l_osigset_t *)];
};
...
struct linux_llseek_args {
	...
	char res_l_[PADL_(l_loff_t *)]; l_loff_t __user * res; char res_r_[PADR_(l_loff_t *)];
	char whence_l_[PADL_(l_uint)]; l_uint whence; char whence_r_[PADR_(l_uint)];
};
struct linux_getdents_args {
	char fd_l_[PADL_(l_uint)]; l_uint fd; char fd_r_[PADR_(l_uint)];
	char dent_l_[PADL_(void *)]; void __user * dent; char dent_r_[PADR_(void *)];
	char count_l_[PADL_(l_uint)]; l_uint count; char count_r_[PADR_(l_uint)];
};
struct linux_select_args {
	char nfds_l_[PADL_(l_int)]; l_int nfds; char nfds_r_[PADR_(l_int)];
	char readfds_l_[PADL_(l_fd_set *)]; l_fd_set __user * readfds; char readfds_r_[PADR_(l_fd_set *)];
	char writefds_l_[PADL_(l_fd_set *)]; l_fd_set __user * writefds; char writefds_r_[PADR_(l_fd_set *)];
	char exceptfds_l_[PADL_(l_fd_set *)]; l_fd_set __user * exceptfds; char exceptfds_r_[PADR_(l_fd_set *)];
	char timeout_l_[PADL_(struct l_timeval *)]; struct l_timeval __user * timeout; char timeout_r_[PADR_(struct l_timeval *)];
};
...
struct linux_sysctl_args {
	char args_l_[PADL_(struct l___sysctl_args *)]; struct l___sysctl_args __user * args; char args_r_[PADR_(struct l___sysctl_args *)];
};
...
struct linux_sched_rr_get_interval_args {
	char pid_l_[PADL_(l_pid_t)]; l_pid_t pid; char pid_r_[PADR_(l_pid_t)];
	char interval_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * interval; char interval_r_[PADR_(struct l_timespec *)];
};
struct linux_nanosleep_args {
	char rqtp_l_[PADL_(const struct l_timespec *)]; const struct l_timespec __user * rqtp; char rqtp_r_[PADR_(const struct l_timespec *)];
	char rmtp_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * rmtp; char rmtp_r_[PADR_(struct l_timespec *)];
};
...
struct linux_getresuid16_args {
	char ruid_l_[PADL_(l_uid16_t *)]; l_uid16_t __user * ruid; char ruid_r_[PADR_(l_uid16_t *)];
	char euid_l_[PADL_(l_uid16_t *)]; l_uid16_t __user * euid; char euid_r_[PADR_(l_uid16_t *)];
	char suid_l_[PADL_(l_uid16_t *)]; l_uid16_t __user * suid; char suid_r_[PADR_(l_uid16_t *)];
};
...
struct linux_getresgid16_args {
	char rgid_l_[PADL_(l_gid16_t *)]; l_gid16_t __user * rgid; char rgid_r_[PADR_(l_gid16_t *)];
	char egid_l_[PADL_(l_gid16_t *)]; l_gid16_t __user * egid; char egid_r_[PADR_(l_gid16_t *)];
	char sgid_l_[PADL_(l_gid16_t *)]; l_gid16_t __user * sgid; char sgid_r_[PADR_(l_gid16_t *)];
};
...
struct linux_rt_sigreturn_args {
	char ucp_l_[PADL_(struct l_ucontext *)]; struct l_ucontext __user * ucp; char ucp_r_[PADR_(struct l_ucontext *)];
};
struct linux_rt_sigaction_args {
	char sig_l_[PADL_(l_int)]; l_int sig; char sig_r_[PADR_(l_int)];
	char act_l_[PADL_(l_sigaction_t *)]; l_sigaction_t __user * act; char act_r_[PADR_(l_sigaction_t *)];
	char oact_l_[PADL_(l_sigaction_t *)]; l_sigaction_t __user * oact; char oact_r_[PADR_(l_sigaction_t *)];
	char sigsetsize_l_[PADL_(l_size_t)]; l_size_t sigsetsize; char sigsetsize_r_[PADR_(l_size_t)];
};
struct linux_rt_sigprocmask_args {
	char how_l_[PADL_(l_int)]; l_int how; char how_r_[PADR_(l_int)];
	char mask_l_[PADL_(l_sigset_t *)]; l_sigset_t __user * mask; char mask_r_[PADR_(l_sigset_t *)];
	char omask_l_[PADL_(l_sigset_t *)]; l_sigset_t __user * omask; char omask_r_[PADR_(l_sigset_t *)];
	char sigsetsize_l_[PADL_(l_size_t)]; l_size_t sigsetsize; char sigsetsize_r_[PADR_(l_size_t)];
};
struct linux_rt_sigpending_args {
	char set_l_[PADL_(l_sigset_t *)]; l_sigset_t __user * set; char set_r_[PADR_(l_sigset_t *)];
	char sigsetsize_l_[PADL_(l_size_t)]; l_size_t sigsetsize; char sigsetsize_r_[PADR_(l_size_t)];
};
struct linux_rt_sigtimedwait_args {
	char mask_l_[PADL_(l_sigset_t *)]; l_sigset_t __user * mask; char mask_r_[PADR_(l_sigset_t *)];
	char ptr_l_[PADL_(l_siginfo_t *)]; l_siginfo_t __user * ptr; char ptr_r_[PADR_(l_siginfo_t *)];
	char timeout_l_[PADL_(struct l_timeval *)]; struct l_timeval __user * timeout; char timeout_r_[PADR_(struct l_timeval *)];
	char sigsetsize_l_[PADL_(l_size_t)]; l_size_t sigsetsize; char sigsetsize_r_[PADR_(l_size_t)];
};
struct linux_rt_sigqueueinfo_args {
	char pid_l_[PADL_(l_pid_t)]; l_pid_t pid; char pid_r_[PADR_(l_pid_t)];
	char sig_l_[PADL_(l_int)]; l_int sig; char sig_r_[PADR_(l_int)];
	char info_l_[PADL_(l_siginfo_t *)]; l_siginfo_t __user * info; char info_r_[PADR_(l_siginfo_t *)];
};
struct linux_rt_sigsuspend_args {
	char newset_l_[PADL_(l_sigset_t *)]; l_sigset_t __user * newset; char newset_r_[PADR_(l_sigset_t *)];
	char sigsetsize_l_[PADL_(l_size_t)]; l_size_t sigsetsize; char sigsetsize_r_[PADR_(l_size_t)];
};
...
struct linux_capget_args {
	char hdrp_l_[PADL_(struct l_user_cap_header *)]; struct l_user_cap_header __user * hdrp; char hdrp_r_[PADR_(struct l_user_cap_header *)];
	char datap_l_[PADL_(struct l_user_cap_data *)]; struct l_user_cap_data __user * datap; char datap_r_[PADR_(struct l_user_cap_data *)];
};
...
struct linux_sigaltstack_args {
	char uss_l_[PADL_(l_stack_t *)]; l_stack_t __user * uss; char uss_r_[PADR_(l_stack_t *)];
	char uoss_l_[PADL_(l_stack_t *)]; l_stack_t __user * uoss; char uoss_r_[PADR_(l_stack_t *)];
};
struct linux_sendfile_args {
	char out_l_[PADL_(l_int)]; l_int out; char out_r_[PADR_(l_int)];
	char in_l_[PADL_(l_int)]; l_int in; char in_r_[PADR_(l_int)];
	char offset_l_[PADL_(l_long *)]; l_long __user * offset; char offset_r_[PADR_(l_long *)];
...
struct linux_stat64_args {
	...
	char statbuf_l_[PADL_(struct l_stat64 *)]; struct l_stat64 __user * statbuf; char statbuf_r_[PADR_(struct l_stat64 *)];
};
...
struct linux_getgroups_args {
	...
	char grouplist_l_[PADL_(l_gid_t *)]; l_gid_t __user * grouplist; char grouplist_r_[PADR_(l_gid_t *)];
};
...
struct linux_pivot_root_args {
	char new_root_l_[PADL_(char *)]; char __user * new_root; char new_root_r_[PADR_(char *)];
	char put_old_l_[PADL_(char *)]; char __user * put_old; char put_old_r_[PADR_(char *)];
};
struct linux_mincore_args {
	char start_l_[PADL_(l_ulong)]; l_ulong start; char start_r_[PADR_(l_ulong)];
	char len_l_[PADL_(l_size_t)]; l_size_t len; char len_r_[PADR_(l_size_t)];
	char vec_l_[PADL_(u_char *)]; u_char __user * vec; char vec_r_[PADR_(u_char *)];
};
struct linux_getdents64_args {
	char fd_l_[PADL_(l_uint)]; l_uint fd; char fd_r_[PADR_(l_uint)];
	char dirent_l_[PADL_(void *)]; void __user * dirent; char dirent_r_[PADR_(void *)];
	char count_l_[PADL_(l_uint)]; l_uint count; char count_r_[PADR_(l_uint)];
};
...
struct linux_sendfile64_args {
	char out_l_[PADL_(l_int)]; l_int out; char out_r_[PADR_(l_int)];
	char in_l_[PADL_(l_int)]; l_int in; char in_r_[PADR_(l_int)];
	char offset_l_[PADL_(l_loff_t *)]; l_loff_t __user * offset; char offset_r_[PADR_(l_loff_t *)];
	char count_l_[PADL_(l_size_t)]; l_size_t count; char count_r_[PADR_(l_size_t)];
};
struct linux_sys_futex_args {
	char uaddr_l_[PADL_(void *)]; void __user * uaddr; char uaddr_r_[PADR_(void *)];
	char op_l_[PADL_(int)]; int op; char op_r_[PADR_(int)];
	char val_l_[PADL_(uint32_t)]; uint32_t val; char val_r_[PADR_(uint32_t)];
	char timeout_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * timeout; char timeout_r_[PADR_(struct l_timespec *)];
	char uaddr2_l_[PADL_(uint32_t *)]; uint32_t __user * uaddr2; char uaddr2_r_[PADR_(uint32_t *)];
...
struct linux_sched_setaffinity_args {
	...
	char user_mask_ptr_l_[PADL_(l_ulong *)]; l_ulong __user * user_mask_ptr; char user_mask_ptr_r_[PADR_(l_ulong *)];
};
...
struct linux_set_thread_area_args {
	char desc_l_[PADL_(struct l_user_desc *)]; struct l_user_desc __user * desc; char desc_r_[PADR_(struct l_user_desc *)];
};
...
struct linux_epoll_ctl_args {
	...
	char fd_l_[PADL_(l_int)]; l_int fd; char fd_r_[PADR_(l_int)];
	char event_l_[PADL_(struct epoll_event *)]; struct epoll_event __user * event; char event_r_[PADR_(struct epoll_event *)];
};
struct linux_epoll_wait_args {
	char epfd_l_[PADL_(l_int)]; l_int epfd; char epfd_r_[PADR_(l_int)];
	char events_l_[PADL_(struct epoll_event *)]; struct epoll_event __user * events; char events_r_[PADR_(struct epoll_event *)];
...
struct linux_set_tid_address_args {
	char tidptr_l_[PADL_(int *)]; int __user * tidptr; char tidptr_r_[PADR_(int *)];
};
struct linux_timer_create_args {
	...
	char timerid_l_[PADL_(l_timer_t *)]; l_timer_t __user * timerid; char timerid_r_[PADR_(l_timer_t *)];
};
struct linux_timer_settime_args {
	char timerid_l_[PADL_(l_timer_t)]; l_timer_t timerid; char timerid_r_[PADR_(l_timer_t)];
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
	char new_l_[PADL_(const struct itimerspec *)]; const struct itimerspec __user * new; char new_r_[PADR_(const struct itimerspec *)];
	char old_l_[PADL_(struct itimerspec *)]; struct itimerspec __user * old; char old_r_[PADR_(struct itimerspec *)];
};
struct linux_timer_gettime_args {
	char timerid_l_[PADL_(l_timer_t)]; l_timer_t timerid; char timerid_r_[PADR_(l_timer_t)];
	char setting_l_[PADL_(struct itimerspec *)]; struct itimerspec __user * setting; char setting_r_[PADR_(struct itimerspec *)];
};
...
struct linux_clock_settime_args {
	...
	char tp_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * tp; char tp_r_[PADR_(struct l_timespec *)];
};
...
struct linux_clock_nanosleep_args {
	...
	char rqtp_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * rqtp; char rqtp_r_[PADR_(struct l_timespec *)];
	char rmtp_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * rmtp; char rmtp_r_[PADR_(struct l_timespec *)];
};
struct linux_statfs64_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char bufsize_l_[PADL_(size_t)]; size_t bufsize; char bufsize_r_[PADR_(size_t)];
	char buf_l_[PADL_(struct l_statfs64_buf *)]; struct l_statfs64_buf __user * buf; char buf_r_[PADR_(struct l_statfs64_buf *)];
};
...
struct linux_utimes_args {
	char fname_l_[PADL_(char *)]; char __user * fname; char fname_r_[PADR_(char *)];
	char tptr_l_[PADL_(struct l_timeval *)]; struct l_timeval __user * tptr; char tptr_r_[PADR_(struct l_timeval *)];
};
...
struct linux_mq_open_args {
	...
	char attr_l_[PADL_(struct mq_attr *)]; struct mq_attr __user * attr; char attr_r_[PADR_(struct mq_attr *)];
};
...
struct linux_mq_timedsend_args {
	...
	char abs_timeout_l_[PADL_(const struct l_timespec *)]; const struct l_timespec __user * abs_timeout; char abs_timeout_r_[PADR_(const struct l_timespec *)];
};
...
struct linux_mkdirat_args {
	char dfd_l_[PADL_(l_int)]; l_int dfd; char dfd_r_[PADR_(l_int)];
	char pathname_l_[PADL_(const char *)]; const char __user * pathname; char pathname_r_[PADR_(const char *)];
	char mode_l_[PADL_(l_int)]; l_int mode; char mode_r_[PADR_(l_int)];
};
...
struct linux_futimesat_args {
	char dfd_l_[PADL_(l_int)]; l_int dfd; char dfd_r_[PADR_(l_int)];
	char filename_l_[PADL_(char *)]; char __user * filename; char filename_r_[PADR_(char *)];
	char utimes_l_[PADL_(struct l_timeval *)]; struct l_timeval __user * utimes; char utimes_r_[PADR_(struct l_timeval *)];
};
struct linux_fstatat64_args {
	char dfd_l_[PADL_(l_int)]; l_int dfd; char dfd_r_[PADR_(l_int)];
	char pathname_l_[PADL_(char *)]; char __user * pathname; char pathname_r_[PADR_(char *)];
	char statbuf_l_[PADL_(struct l_stat64 *)]; struct l_stat64 __user * statbuf; char statbuf_r_[PADR_(struct l_stat64 *)];
	char flag_l_[PADL_(l_int)]; l_int flag; char flag_r_[PADR_(l_int)];
};
...
struct linux_renameat_args {
	...
	char oldname_l_[PADL_(const char *)]; const char __user * oldname; char oldname_r_[PADR_(const char *)];
	char newdfd_l_[PADL_(l_int)]; l_int newdfd; char newdfd_r_[PADR_(l_int)];
	char newname_l_[PADL_(const char *)]; const char __user * newname; char newname_r_[PADR_(const char *)];
};
...
struct linux_pselect6_args {
	...
	char writefds_l_[PADL_(l_fd_set *)]; l_fd_set __user * writefds; char writefds_r_[PADR_(l_fd_set *)];
	char exceptfds_l_[PADL_(l_fd_set *)]; l_fd_set __user * exceptfds; char exceptfds_r_[PADR_(l_fd_set *)];
	char tsp_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * tsp; char tsp_r_[PADR_(struct l_timespec *)];
	char sig_l_[PADL_(l_uintptr_t *)]; l_uintptr_t __user * sig; char sig_r_[PADR_(l_uintptr_t *)];
};
struct linux_ppoll_args {
	...
	char tsp_l_[PADL_(struct l_timespec *)]; struct l_timespec __user * tsp; char tsp_r_[PADR_(struct l_timespec *)];
	char sset_l_[PADL_(l_sigset_t *)]; l_sigset_t __user * sset; char sset_r_[PADR_(l_sigset_t *)];
...
struct linux_set_robust_list_args {
	char head_l_[PADL_(struct linux_robust_list_head *)]; struct linux_robust_list_head __user * head; char head_r_[PADR_(struct linux_robust_list_head *)];
	char len_l_[PADL_(l_size_t)]; l_size_t len; char len_r_[PADR_(l_size_t)];
};
struct linux_get_robust_list_args {
	char pid_l_[PADL_(l_int)]; l_int pid; char pid_r_[PADR_(l_int)];
	char head_l_[PADL_(struct linux_robust_list_head **)]; struct linux_robust_list_head __user * __user * head; char head_r_[PADR_(struct linux_robust_list_head **)];
	char len_l_[PADL_(l_size_t *)]; l_size_t __user * len; char len_r_[PADR_(l_size_t *)];
};
...
struct linux_getcpu_args {
	char cpu_l_[PADL_(l_uint *)]; l_uint __user * cpu; char cpu_r_[PADR_(l_uint *)];
	char node_l_[PADL_(l_uint *)]; l_uint __user * node; char node_r_[PADR_(l_uint *)];
	char cache_l_[PADL_(void *)]; void __user * cache; char cache_r_[PADR_(void *)];
};
...
struct linux_utimensat_args {
	char dfd_l_[PADL_(l_int)]; l_int dfd; char dfd_r_[PADR_(l_int)];
	char pathname_l_[PADL_(const char *)]; const char __user * pathname; char pathname_r_[PADR_(const char *)];
	char times_l_[PADL_(const struct l_timespec *)]; const struct l_timespec __user * times; char times_r_[PADR_(const struct l_timespec *)];
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
};
...
struct linux_timerfd_settime_args {
	char fd_l_[PADL_(l_int)]; l_int fd; char fd_r_[PADR_(l_int)];
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
	char new_value_l_[PADL_(const struct l_itimerspec *)]; const struct l_itimerspec __user * new_value; char new_value_r_[PADR_(const struct l_itimerspec *)];
	char old_value_l_[PADL_(struct l_itimerspec *)]; struct l_itimerspec __user * old_value; char old_value_r_[PADR_(struct l_itimerspec *)];
};
...
struct linux_preadv_args {
	char fd_l_[PADL_(l_ulong)]; l_ulong fd; char fd_r_[PADR_(l_ulong)];
	char vec_l_[PADL_(struct iovec *)]; struct iovec __user * vec; char vec_r_[PADR_(struct iovec *)];
...
struct linux_rt_tgsigqueueinfo_args {
	...
	char sig_l_[PADL_(l_int)]; l_int sig; char sig_r_[PADR_(l_int)];
	char uinfo_l_[PADL_(l_siginfo_t *)]; l_siginfo_t __user * uinfo; char uinfo_r_[PADR_(l_siginfo_t *)];
};
...
struct linux_recvmmsg_args {
	...
	char msg_l_[PADL_(struct l_mmsghdr *)]; struct l_mmsghdr __user * msg; char msg_r_[PADR_(struct l_mmsghdr *)];
...
struct linux_prlimit64_args {
	char pid_l_[PADL_(l_pid_t)]; l_pid_t pid; char pid_r_[PADR_(l_pid_t)];
	char resource_l_[PADL_(l_uint)]; l_uint resource; char resource_r_[PADR_(l_uint)];
	char new_l_[PADL_(struct rlimit *)]; struct rlimit __user * new; char new_r_[PADR_(struct rlimit *)];
	char old_l_[PADL_(struct rlimit *)]; struct rlimit __user * old; char old_r_[PADR_(struct rlimit *)];
};
...
struct linux_process_vm_readv_args {
	char pid_l_[PADL_(l_pid_t)]; l_pid_t pid; char pid_r_[PADR_(l_pid_t)];
	char lvec_l_[PADL_(const struct iovec *)]; const struct iovec __user * lvec; char lvec_r_[PADR_(const struct iovec *)];
	char liovcnt_l_[PADL_(l_ulong)]; l_ulong liovcnt; char liovcnt_r_[PADR_(l_ulong)];
	char rvec_l_[PADL_(const struct iovec *)]; const struct iovec __user * rvec; char rvec_r_[PADR_(const struct iovec *)];
...
struct linux_finit_module_args {
	char fd_l_[PADL_(l_int)]; l_int fd; char fd_r_[PADR_(l_int)];
	char uargs_l_[PADL_(const char *)]; const char __user * uargs; char uargs_r_[PADR_(const char *)];
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
};
struct linux_sched_setattr_args {
	char pid_l_[PADL_(l_pid_t)]; l_pid_t pid; char pid_r_[PADR_(l_pid_t)];
	char attr_l_[PADL_(void *)]; void __user * attr; char attr_r_[PADR_(void *)];
	char flags_l_[PADL_(l_uint)]; l_uint flags; char flags_r_[PADR_(l_uint)];
};
...
struct linux_memfd_create_args {
	char uname_ptr_l_[PADL_(const char *)]; const char __user * uname_ptr; char uname_ptr_r_[PADR_(const char *)];
	char flags_l_[PADL_(l_uint)]; l_uint flags; char flags_r_[PADR_(l_uint)];
};
...
struct linux_execveat_args {
	char dfd_l_[PADL_(l_int)]; l_int dfd; char dfd_r_[PADR_(l_int)];
	char filename_l_[PADL_(const char *)]; const char __user * filename; char filename_r_[PADR_(const char *)];
	char argv_l_[PADL_(const char **)]; const char __user * __user * argv; char argv_r_[PADR_(const char **)];
	char envp_l_[PADL_(const char **)]; const char __user * __user * envp; char envp_r_[PADR_(const char **)];
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
};
...
struct linux_copy_file_range_args {
	...
	char off_in_l_[PADL_(l_loff_t *)]; l_loff_t __user * off_in; char off_in_r_[PADR_(l_loff_t *)];
	char fd_out_l_[PADL_(l_int)]; l_int fd_out; char fd_out_r_[PADR_(l_int)];
	char off_out_l_[PADL_(l_loff_t *)]; l_loff_t __user * off_out; char off_out_r_[PADR_(l_loff_t *)];
	char len_l_[PADL_(l_size_t)]; l_size_t len; char len_r_[PADR_(l_size_t)];
	char flags_l_[PADL_(l_uint)]; l_uint flags; char flags_r_[PADR_(l_uint)];
};
struct linux_preadv2_args {
	char fd_l_[PADL_(l_ulong)]; l_ulong fd; char fd_r_[PADR_(l_ulong)];
	char vec_l_[PADL_(const struct iovec *)]; const struct iovec __user * vec; char vec_r_[PADR_(const struct iovec *)];
	char vlen_l_[PADL_(l_ulong)]; l_ulong vlen; char vlen_r_[PADR_(l_ulong)];
	char pos_l_l_[PADL_(l_ulong)]; l_ulong pos_l; char pos_l_r_[PADR_(l_ulong)];
	char pos_h_l_[PADL_(l_ulong)]; l_ulong pos_h; char pos_h_r_[PADR_(l_ulong)];
	char flags_l_[PADL_(l_int)]; l_int flags; char flags_r_[PADR_(l_int)];
...
struct linux_statx_args {
	...
	char statxbuf_l_[PADL_(void *)]; void __user * statxbuf; char statxbuf_r_[PADR_(void *)];
};
...
struct linux_shmctl_args {
	...
	char cmd_l_[PADL_(l_int)]; l_int cmd; char cmd_r_[PADR_(l_int)];
	char buf_l_[PADL_(struct l_shmid_ds *)]; struct l_shmid_ds __user * buf; char buf_r_[PADR_(struct l_shmid_ds *)];
};
struct linux_shmat_args {
	char shmid_l_[PADL_(l_int)]; l_int shmid; char shmid_r_[PADR_(l_int)];
	char shmaddr_l_[PADL_(char *)]; char __user * shmaddr; char shmaddr_r_[PADR_(char *)];
	char shmflg_l_[PADL_(l_int)]; l_int shmflg; char shmflg_r_[PADR_(l_int)];
};
...
struct linux_msgsnd_args {
	...
	char msgp_l_[PADL_(struct l_msgbuf *)]; struct l_msgbuf __user * msgp; char msgp_r_[PADR_(struct l_msgbuf *)];
...
struct linux_msgctl_args {
	char msqid_l_[PADL_(l_int)]; l_int msqid; char msqid_r_[PADR_(l_int)];
	char cmd_l_[PADL_(l_int)]; l_int cmd; char cmd_r_[PADR_(l_int)];
	char buf_l_[PADL_(struct l_msqid_ds *)]; struct l_msqid_ds __user * buf; char buf_r_[PADR_(struct l_msqid_ds *)];
};
