 ...
 *
 * DO NOT EDIT-- this file is automatically @generated by sys/tools/makesyscalls.lua.
 * $FreeBSD$
 */
...
struct read_args {
	...
	char buf_l_[PADL_(void *)]; void __user * buf; char buf_r_[PADR_(void *)];
	char nbyte_l_[PADL_(size_t)]; size_t nbyte; char nbyte_r_[PADR_(size_t)];
};
struct write_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char buf_l_[PADL_(const void *)]; const void __user * buf; char buf_r_[PADR_(const void *)];
	char nbyte_l_[PADL_(size_t)]; size_t nbyte; char nbyte_r_[PADR_(size_t)];
};
struct open_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
...
struct wait4_args {
	...
	char status_l_[PADL_(int *)]; int __user * status; char status_r_[PADR_(int *)];
	char options_l_[PADL_(int)]; int options; char options_r_[PADR_(int)];
	char rusage_l_[PADL_(struct rusage *)]; struct rusage __user * rusage; char rusage_r_[PADR_(struct rusage *)];
};
struct link_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char link_l_[PADL_(const char *)]; const char __user * link; char link_r_[PADR_(const char *)];
};
struct unlink_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
};
...
struct break_args {
	char nsize_l_[PADL_(char *)]; char __user * nsize; char nsize_r_[PADR_(char *)];
};
struct getpid_args {
	register_t dummy;
};
struct mount_args {
	char type_l_[PADL_(const char *)]; const char __user * type; char type_r_[PADR_(const char *)];
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char data_l_[PADL_(void *)]; void __user * data; char data_r_[PADR_(void *)];
};
struct unmount_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
...
struct ptrace_args {
	...
	char addr_l_[PADL_(caddr_t)]; char __user * addr; char addr_r_[PADR_(caddr_t)];
	char data_l_[PADL_(int)]; int data; char data_r_[PADR_(int)];
};
struct recvmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char msg_l_[PADL_(struct msghdr *)]; struct msghdr __user * msg; char msg_r_[PADR_(struct msghdr *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct sendmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
...
struct recvfrom_args {
	...
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char from_l_[PADL_(struct sockaddr *)]; struct sockaddr __user * from; char from_r_[PADR_(struct sockaddr *)];
	char fromlenaddr_l_[PADL_(__socklen_t *)]; __socklen_t __user * fromlenaddr; char fromlenaddr_r_[PADR_(__socklen_t *)];
};
struct accept_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char name_l_[PADL_(struct sockaddr *)]; struct sockaddr __user * name; char name_r_[PADR_(struct sockaddr *)];
	char anamelen_l_[PADL_(__socklen_t *)]; __socklen_t __user * anamelen; char anamelen_r_[PADR_(__socklen_t *)];
};
struct getpeername_args {
	char fdes_l_[PADL_(int)]; int fdes; char fdes_r_[PADR_(int)];
	char asa_l_[PADL_(struct sockaddr *)]; struct sockaddr __user * asa; char asa_r_[PADR_(struct sockaddr *)];
	char alen_l_[PADL_(__socklen_t *)]; __socklen_t __user * alen; char alen_r_[PADR_(__socklen_t *)];
};
...
struct profil_args {
	char samples_l_[PADL_(char *)]; char __user * samples; char samples_r_[PADR_(char *)];
...
struct ktrace_args {
	char fname_l_[PADL_(const char *)]; const char __user * fname; char fname_r_[PADR_(const char *)];
...
struct getlogin_args {
	char namebuf_l_[PADL_(char *)]; char __user * namebuf; char namebuf_r_[PADR_(char *)];
	char namelen_l_[PADL_(u_int)]; u_int namelen; char namelen_r_[PADR_(u_int)];
};
struct setlogin_args {
	char namebuf_l_[PADL_(const char *)]; const char __user * namebuf; char namebuf_r_[PADR_(const char *)];
};
struct acct_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
};
...
struct sigaltstack_args {
	char ss_l_[PADL_(stack_t *)]; stack_t __user * ss; char ss_r_[PADR_(stack_t *)];
	char oss_l_[PADL_(stack_t *)]; stack_t __user * oss; char oss_r_[PADR_(stack_t *)];
};
struct ioctl_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char com_l_[PADL_(u_long)]; u_long com; char com_r_[PADR_(u_long)];
	char data_l_[PADL_(char *)]; char __user * data; char data_r_[PADR_(char *)];
};
struct reboot_args {
...
struct readlink_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char buf_l_[PADL_(char *)]; char __user * buf; char buf_r_[PADR_(char *)];
	char count_l_[PADL_(size_t)]; size_t count; char count_r_[PADR_(size_t)];
};
struct execve_args {
	char fname_l_[PADL_(const char *)]; const char __user * fname; char fname_r_[PADR_(const char *)];
	char argv_l_[PADL_(char **)]; char __user * __user * argv; char argv_r_[PADR_(char **)];
	char envv_l_[PADL_(char **)]; char __user * __user * envv; char envv_r_[PADR_(char **)];
};
struct umask_args {
...
struct msync_args {
	char addr_l_[PADL_(void *)]; void __user * addr; char addr_r_[PADR_(void *)];
	char len_l_[PADL_(size_t)]; size_t len; char len_r_[PADR_(size_t)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct vfork_args {
...
struct mincore_args {
	char addr_l_[PADL_(const void *)]; const void __user * addr; char addr_r_[PADR_(const void *)];
	char len_l_[PADL_(size_t)]; size_t len; char len_r_[PADR_(size_t)];
	char vec_l_[PADL_(char *)]; char __user * vec; char vec_r_[PADR_(char *)];
};
struct getgroups_args {
	char gidsetsize_l_[PADL_(u_int)]; u_int gidsetsize; char gidsetsize_r_[PADR_(u_int)];
	char gidset_l_[PADL_(gid_t *)]; gid_t __user * gidset; char gidset_r_[PADR_(gid_t *)];
};
...
struct setitimer_args {
	...
	char itv_l_[PADL_(struct itimerval *)]; struct itimerval __user * itv; char itv_r_[PADR_(struct itimerval *)];
	char oitv_l_[PADL_(struct itimerval *)]; struct itimerval __user * oitv; char oitv_r_[PADR_(struct itimerval *)];
};
struct owait_args {
	register_t dummy;
};
struct swapon_args {
	char name_l_[PADL_(const char *)]; const char __user * name; char name_r_[PADR_(const char *)];
};
...
struct select_args {
	...
	char in_l_[PADL_(fd_set *)]; fd_set __user * in; char in_r_[PADR_(fd_set *)];
	char ou_l_[PADL_(fd_set *)]; fd_set __user * ou; char ou_r_[PADR_(fd_set *)];
	char ex_l_[PADL_(fd_set *)]; fd_set __user * ex; char ex_r_[PADR_(fd_set *)];
	char tv_l_[PADL_(struct timeval *)]; struct timeval __user * tv; char tv_r_[PADR_(struct timeval *)];
};
struct fsync_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
};
...
struct connect_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char name_l_[PADL_(const struct sockaddr *)]; const struct sockaddr __user * name; char name_r_[PADR_(const struct sockaddr *)];
...
struct setsockopt_args {
	...
	char val_l_[PADL_(const void *)]; const void __user * val; char val_r_[PADR_(const void *)];
...
struct gettimeofday_args {
	char tp_l_[PADL_(struct timeval *)]; struct timeval __user * tp; char tp_r_[PADR_(struct timeval *)];
	char tzp_l_[PADL_(struct timezone *)]; struct timezone __user * tzp; char tzp_r_[PADR_(struct timezone *)];
};
...
struct getsockopt_args {
	...
	char level_l_[PADL_(int)]; int level; char level_r_[PADR_(int)];
	char name_l_[PADL_(int)]; int name; char name_r_[PADR_(int)];
	char val_l_[PADL_(void *)]; void __user * val; char val_r_[PADR_(void *)];
	char avalsize_l_[PADL_(int *)]; int __user * avalsize; char avalsize_r_[PADR_(int *)];
};
struct readv_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char iovp_l_[PADL_(struct iovec *)]; struct iovec __user * iovp; char iovp_r_[PADR_(struct iovec *)];
...
struct rename_args {
	char from_l_[PADL_(const char *)]; const char __user * from; char from_r_[PADR_(const char *)];
	char to_l_[PADL_(const char *)]; const char __user * to; char to_r_[PADR_(const char *)];
};
struct flock_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
...
struct sendto_args {
	...
	char len_l_[PADL_(size_t)]; size_t len; char len_r_[PADR_(size_t)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char to_l_[PADL_(const struct sockaddr *)]; const struct sockaddr __user * to; char to_r_[PADR_(const struct sockaddr *)];
...
struct socketpair_args {
	...
	char type_l_[PADL_(int)]; int type; char type_r_[PADR_(int)];
	char protocol_l_[PADL_(int)]; int protocol; char protocol_r_[PADR_(int)];
	char rsv_l_[PADL_(int *)]; int __user * rsv; char rsv_r_[PADR_(int *)];
};
struct mkdir_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char mode_l_[PADL_(mode_t)]; mode_t mode; char mode_r_[PADR_(mode_t)];
...
struct utimes_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char tptr_l_[PADL_(struct timeval *)]; struct timeval __user * tptr; char tptr_r_[PADR_(struct timeval *)];
};
struct adjtime_args {
	char delta_l_[PADL_(struct timeval *)]; struct timeval __user * delta; char delta_r_[PADR_(struct timeval *)];
	char olddelta_l_[PADL_(struct timeval *)]; struct timeval __user * olddelta; char olddelta_r_[PADR_(struct timeval *)];
};
...
struct quotactl_args {
	...
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char uid_l_[PADL_(int)]; int uid; char uid_r_[PADR_(int)];
	char arg_l_[PADL_(void *)]; void __user * arg; char arg_r_[PADR_(void *)];
};
struct oquota_args {
	register_t dummy;
};
struct nlm_syscall_args {
	...
	char addrs_l_[PADL_(char **)]; char __user * __user * addrs; char addrs_r_[PADR_(char **)];
};
struct nfssvc_args {
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
	char argp_l_[PADL_(void *)]; void __user * argp; char argp_r_[PADR_(void *)];
};
struct lgetfh_args {
	char fname_l_[PADL_(const char *)]; const char __user * fname; char fname_r_[PADR_(const char *)];
	char fhp_l_[PADL_(struct fhandle *)]; struct fhandle __user * fhp; char fhp_r_[PADR_(struct fhandle *)];
};
struct getfh_args {
	char fname_l_[PADL_(const char *)]; const char __user * fname; char fname_r_[PADR_(const char *)];
	char fhp_l_[PADL_(struct fhandle *)]; struct fhandle __user * fhp; char fhp_r_[PADR_(struct fhandle *)];
...
struct sysarch_args {
	...
	char parms_l_[PADL_(char *)]; char __user * parms; char parms_r_[PADR_(char *)];
};
struct rtprio_args {
	char function_l_[PADL_(int)]; int function; char function_r_[PADR_(int)];
	char pid_l_[PADL_(pid_t)]; pid_t pid; char pid_r_[PADR_(pid_t)];
	char rtp_l_[PADL_(struct rtprio *)]; struct rtprio __user * rtp; char rtp_r_[PADR_(struct rtprio *)];
};
struct semsys_args {
	char which_l_[PADL_(int)]; int which; char which_r_[PADR_(int)];
...
struct ntp_adjtime_args {
	char tp_l_[PADL_(struct timex *)]; struct timex __user * tp; char tp_r_[PADR_(struct timex *)];
};
struct setgid_args {
...
struct __getrlimit_args {
	char which_l_[PADL_(u_int)]; u_int which; char which_r_[PADR_(u_int)];
	char rlp_l_[PADL_(struct rlimit *)]; struct rlimit __user * rlp; char rlp_r_[PADR_(struct rlimit *)];
};
...
struct sysctl_args {
	char name_l_[PADL_(int *)]; int __user * name; char name_r_[PADR_(int *)];
	char namelen_l_[PADL_(u_int)]; u_int namelen; char namelen_r_[PADR_(u_int)];
	char old_l_[PADL_(void *)]; void __user * old; char old_r_[PADR_(void *)];
	char oldlenp_l_[PADL_(size_t *)]; size_t __user * oldlenp; char oldlenp_r_[PADR_(size_t *)];
	char new_l_[PADL_(const void *)]; const void __user * new; char new_r_[PADR_(const void *)];
...
struct poll_args {
	char fds_l_[PADL_(struct pollfd *)]; struct pollfd __user * fds; char fds_r_[PADR_(struct pollfd *)];
...
struct semop_args {
	...
	char sops_l_[PADL_(struct sembuf *)]; struct sembuf __user * sops; char sops_r_[PADR_(struct sembuf *)];
...
struct msgsnd_args {
	...
	char msgp_l_[PADL_(const void *)]; const void __user * msgp; char msgp_r_[PADR_(const void *)];
	char msgsz_l_[PADL_(size_t)]; size_t msgsz; char msgsz_r_[PADR_(size_t)];
	char msgflg_l_[PADL_(int)]; int msgflg; char msgflg_r_[PADR_(int)];
};
struct msgrcv_args {
	char msqid_l_[PADL_(int)]; int msqid; char msqid_r_[PADR_(int)];
	char msgp_l_[PADL_(void *)]; void __user * msgp; char msgp_r_[PADR_(void *)];
	char msgsz_l_[PADL_(size_t)]; size_t msgsz; char msgsz_r_[PADR_(size_t)];
...
struct shmat_args {
	...
	char shmaddr_l_[PADL_(const void *)]; const void __user * shmaddr; char shmaddr_r_[PADR_(const void *)];
...
struct clock_gettime_args {
	...
	char tp_l_[PADL_(struct timespec *)]; struct timespec __user * tp; char tp_r_[PADR_(struct timespec *)];
};
struct clock_settime_args {
	char clock_id_l_[PADL_(clockid_t)]; clockid_t clock_id; char clock_id_r_[PADR_(clockid_t)];
	char tp_l_[PADL_(const struct timespec *)]; const struct timespec __user * tp; char tp_r_[PADR_(const struct timespec *)];
};
...
struct ktimer_create_args {
	char clock_id_l_[PADL_(clockid_t)]; clockid_t clock_id; char clock_id_r_[PADR_(clockid_t)];
	char evp_l_[PADL_(struct sigevent *)]; struct sigevent __user * evp; char evp_r_[PADR_(struct sigevent *)];
	char timerid_l_[PADL_(int *)]; int __user * timerid; char timerid_r_[PADR_(int *)];
};
...
struct ktimer_settime_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char value_l_[PADL_(const struct itimerspec *)]; const struct itimerspec __user * value; char value_r_[PADR_(const struct itimerspec *)];
	char ovalue_l_[PADL_(struct itimerspec *)]; struct itimerspec __user * ovalue; char ovalue_r_[PADR_(struct itimerspec *)];
};
struct ktimer_gettime_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
	char value_l_[PADL_(struct itimerspec *)]; struct itimerspec __user * value; char value_r_[PADR_(struct itimerspec *)];
};
struct ktimer_getoverrun_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
};
struct nanosleep_args {
	char rqtp_l_[PADL_(const struct timespec *)]; const struct timespec __user * rqtp; char rqtp_r_[PADR_(const struct timespec *)];
	char rmtp_l_[PADL_(struct timespec *)]; struct timespec __user * rmtp; char rmtp_r_[PADR_(struct timespec *)];
};
struct ffclock_getcounter_args {
	char ffcount_l_[PADL_(ffcounter *)]; ffcounter __user * ffcount; char ffcount_r_[PADR_(ffcounter *)];
};
struct ffclock_setestimate_args {
	char cest_l_[PADL_(struct ffclock_estimate *)]; struct ffclock_estimate __user * cest; char cest_r_[PADR_(struct ffclock_estimate *)];
};
...
struct clock_getcpuclockid2_args {
	...
	char which_l_[PADL_(int)]; int which; char which_r_[PADR_(int)];
	char clock_id_l_[PADL_(clockid_t *)]; clockid_t __user * clock_id; char clock_id_r_[PADR_(clockid_t *)];
};
struct ntp_gettime_args {
	char ntvp_l_[PADL_(struct ntptimeval *)]; struct ntptimeval __user * ntvp; char ntvp_r_[PADR_(struct ntptimeval *)];
};
...
struct aio_read_args {
	char aiocbp_l_[PADL_(struct aiocb *)]; struct aiocb __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb *)];
};
...
struct lio_listio_args {
	...
	char acb_list_l_[PADL_(struct aiocb * const *)]; struct aiocb __user * const __user * acb_list; char acb_list_r_[PADR_(struct aiocb * const *)];
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char sig_l_[PADL_(struct sigevent *)]; struct sigevent __user * sig; char sig_r_[PADR_(struct sigevent *)];
};
struct lchmod_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char mode_l_[PADL_(mode_t)]; mode_t mode; char mode_r_[PADR_(mode_t)];
...
struct fhopen_args {
	char u_fhp_l_[PADL_(const struct fhandle *)]; const struct fhandle __user * u_fhp; char u_fhp_r_[PADR_(const struct fhandle *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct modnext_args {
...
struct modstat_args {
	char modid_l_[PADL_(int)]; int modid; char modid_r_[PADR_(int)];
	char stat_l_[PADL_(struct module_stat *)]; struct module_stat __user * stat; char stat_r_[PADR_(struct module_stat *)];
};
...
struct kldload_args {
	char file_l_[PADL_(const char *)]; const char __user * file; char file_r_[PADR_(const char *)];
};
...
struct kldstat_args {
	char fileid_l_[PADL_(int)]; int fileid; char fileid_r_[PADR_(int)];
	char stat_l_[PADL_(struct kld_file_stat *)]; struct kld_file_stat __user * stat; char stat_r_[PADR_(struct kld_file_stat *)];
};
...
struct aio_suspend_args {
	char aiocbp_l_[PADL_(struct aiocb * const *)]; struct aiocb __user * const __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb * const *)];
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct timespec *)]; const struct timespec __user * timeout; char timeout_r_[PADR_(const struct timespec *)];
};
...
struct sched_setparam_args {
	char pid_l_[PADL_(pid_t)]; pid_t pid; char pid_r_[PADR_(pid_t)];
	char param_l_[PADL_(const struct sched_param *)]; const struct sched_param __user * param; char param_r_[PADR_(const struct sched_param *)];
};
struct sched_getparam_args {
	char pid_l_[PADL_(pid_t)]; pid_t pid; char pid_r_[PADR_(pid_t)];
	char param_l_[PADL_(struct sched_param *)]; struct sched_param __user * param; char param_r_[PADR_(struct sched_param *)];
};
...
struct sched_rr_get_interval_args {
	char pid_l_[PADL_(pid_t)]; pid_t pid; char pid_r_[PADR_(pid_t)];
	char interval_l_[PADL_(struct timespec *)]; struct timespec __user * interval; char interval_r_[PADR_(struct timespec *)];
};
struct utrace_args {
	char addr_l_[PADL_(const void *)]; const void __user * addr; char addr_r_[PADR_(const void *)];
	char len_l_[PADL_(size_t)]; size_t len; char len_r_[PADR_(size_t)];
...
struct jail_args {
	char jail_l_[PADL_(struct jail *)]; struct jail __user * jail; char jail_r_[PADR_(struct jail *)];
};
struct nnpfs_syscall_args {
	char operation_l_[PADL_(int)]; int operation; char operation_r_[PADR_(int)];
	char a_pathP_l_[PADL_(char *)]; char __user * a_pathP; char a_pathP_r_[PADR_(char *)];
	char a_opcode_l_[PADL_(int)]; int a_opcode; char a_opcode_r_[PADR_(int)];
	char a_paramsP_l_[PADL_(void *)]; void __user * a_paramsP; char a_paramsP_r_[PADR_(void *)];
	char a_followSymlinks_l_[PADL_(int)]; int a_followSymlinks; char a_followSymlinks_r_[PADR_(int)];
};
struct sigprocmask_args {
	char how_l_[PADL_(int)]; int how; char how_r_[PADR_(int)];
	char set_l_[PADL_(const sigset_t *)]; const sigset_t __user * set; char set_r_[PADR_(const sigset_t *)];
	char oset_l_[PADL_(sigset_t *)]; sigset_t __user * oset; char oset_r_[PADR_(sigset_t *)];
};
struct sigsuspend_args {
	char sigmask_l_[PADL_(const sigset_t *)]; const sigset_t __user * sigmask; char sigmask_r_[PADR_(const sigset_t *)];
};
struct sigpending_args {
	char set_l_[PADL_(sigset_t *)]; sigset_t __user * set; char set_r_[PADR_(sigset_t *)];
};
struct sigtimedwait_args {
	char set_l_[PADL_(const sigset_t *)]; const sigset_t __user * set; char set_r_[PADR_(const sigset_t *)];
	char info_l_[PADL_(siginfo_t *)]; siginfo_t __user * info; char info_r_[PADR_(siginfo_t *)];
	char timeout_l_[PADL_(const struct timespec *)]; const struct timespec __user * timeout; char timeout_r_[PADR_(const struct timespec *)];
};
...
struct __acl_get_file_args {
	...
	char aclp_l_[PADL_(struct acl *)]; struct acl __user * aclp; char aclp_r_[PADR_(struct acl *)];
};
...
struct extattrctl_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char filename_l_[PADL_(const char *)]; const char __user * filename; char filename_r_[PADR_(const char *)];
	char attrnamespace_l_[PADL_(int)]; int attrnamespace; char attrnamespace_r_[PADR_(int)];
	char attrname_l_[PADL_(const char *)]; const char __user * attrname; char attrname_r_[PADR_(const char *)];
};
...
struct aio_waitcomplete_args {
	char aiocbp_l_[PADL_(struct aiocb **)]; struct aiocb __user * __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb **)];
	char timeout_l_[PADL_(struct timespec *)]; struct timespec __user * timeout; char timeout_r_[PADR_(struct timespec *)];
};
struct getresuid_args {
	char ruid_l_[PADL_(uid_t *)]; uid_t __user * ruid; char ruid_r_[PADR_(uid_t *)];
	char euid_l_[PADL_(uid_t *)]; uid_t __user * euid; char euid_r_[PADR_(uid_t *)];
	char suid_l_[PADL_(uid_t *)]; uid_t __user * suid; char suid_r_[PADR_(uid_t *)];
};
struct getresgid_args {
	char rgid_l_[PADL_(gid_t *)]; gid_t __user * rgid; char rgid_r_[PADR_(gid_t *)];
	char egid_l_[PADL_(gid_t *)]; gid_t __user * egid; char egid_r_[PADR_(gid_t *)];
	char sgid_l_[PADL_(gid_t *)]; gid_t __user * sgid; char sgid_r_[PADR_(gid_t *)];
};
struct kqueue_args {
	register_t dummy;
};
...
struct __mac_get_proc_args {
	char mac_p_l_[PADL_(struct mac *)]; struct mac __user * mac_p; char mac_p_r_[PADR_(struct mac *)];
};
...
struct __mac_get_file_args {
	char path_p_l_[PADL_(const char *)]; const char __user * path_p; char path_p_r_[PADR_(const char *)];
	char mac_p_l_[PADL_(struct mac *)]; struct mac __user * mac_p; char mac_p_r_[PADR_(struct mac *)];
};
...
struct kenv_args {
	...
	char name_l_[PADL_(const char *)]; const char __user * name; char name_r_[PADR_(const char *)];
	char value_l_[PADL_(char *)]; char __user * value; char value_r_[PADR_(char *)];
...
struct uuidgen_args {
	char store_l_[PADL_(struct uuid *)]; struct uuid __user * store; char store_r_[PADR_(struct uuid *)];
...
struct sendfile_args {
	...
	char offset_l_[PADL_(off_t)]; off_t offset; char offset_r_[PADR_(off_t)];
	char nbytes_l_[PADL_(size_t)]; size_t nbytes; char nbytes_r_[PADR_(size_t)];
	char hdtr_l_[PADL_(struct sf_hdtr *)]; struct sf_hdtr __user * hdtr; char hdtr_r_[PADR_(struct sf_hdtr *)];
	char sbytes_l_[PADL_(off_t *)]; off_t __user * sbytes; char sbytes_r_[PADR_(off_t *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct mac_syscall_args {
	char policy_l_[PADL_(const char *)]; const char __user * policy; char policy_r_[PADR_(const char *)];
...
struct ksem_init_args {
	char idp_l_[PADL_(semid_t *)]; semid_t __user * idp; char idp_r_[PADR_(semid_t *)];
...
struct ksem_getvalue_args {
	char id_l_[PADL_(semid_t)]; semid_t id; char id_r_[PADR_(semid_t)];
	char val_l_[PADL_(int *)]; int __user * val; char val_r_[PADR_(int *)];
};
...
struct sigaction_args {
	...
	char act_l_[PADL_(const struct sigaction *)]; const struct sigaction __user * act; char act_r_[PADR_(const struct sigaction *)];
	char oact_l_[PADL_(struct sigaction *)]; struct sigaction __user * oact; char oact_r_[PADR_(struct sigaction *)];
};
struct sigreturn_args {
	char sigcntxp_l_[PADL_(const struct __ucontext *)]; const struct __ucontext __user * sigcntxp; char sigcntxp_r_[PADR_(const struct __ucontext *)];
};
struct getcontext_args {
	char ucp_l_[PADL_(struct __ucontext *)]; struct __ucontext __user * ucp; char ucp_r_[PADR_(struct __ucontext *)];
};
struct setcontext_args {
	char ucp_l_[PADL_(const struct __ucontext *)]; const struct __ucontext __user * ucp; char ucp_r_[PADR_(const struct __ucontext *)];
};
struct swapcontext_args {
	char oucp_l_[PADL_(struct __ucontext *)]; struct __ucontext __user * oucp; char oucp_r_[PADR_(struct __ucontext *)];
	char ucp_l_[PADL_(const struct __ucontext *)]; const struct __ucontext __user * ucp; char ucp_r_[PADR_(const struct __ucontext *)];
};
struct swapoff_args {
	char name_l_[PADL_(const char *)]; const char __user * name; char name_r_[PADR_(const char *)];
...
struct sigwait_args {
	char set_l_[PADL_(const sigset_t *)]; const sigset_t __user * set; char set_r_[PADR_(const sigset_t *)];
	char sig_l_[PADL_(int *)]; int __user * sig; char sig_r_[PADR_(int *)];
};
struct thr_create_args {
	char ctx_l_[PADL_(ucontext_t *)]; ucontext_t __user * ctx; char ctx_r_[PADR_(ucontext_t *)];
	char id_l_[PADL_(long *)]; long __user * id; char id_r_[PADR_(long *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct thr_exit_args {
	char state_l_[PADL_(long *)]; long __user * state; char state_r_[PADR_(long *)];
};
...
struct ksem_timedwait_args {
	char id_l_[PADL_(semid_t)]; semid_t id; char id_r_[PADR_(semid_t)];
	char abstime_l_[PADL_(const struct timespec *)]; const struct timespec __user * abstime; char abstime_r_[PADR_(const struct timespec *)];
};
...
struct audit_args {
	char record_l_[PADL_(const void *)]; const void __user * record; char record_r_[PADR_(const void *)];
...
struct getauid_args {
	char auid_l_[PADL_(uid_t *)]; uid_t __user * auid; char auid_r_[PADR_(uid_t *)];
};
struct setauid_args {
	char auid_l_[PADL_(uid_t *)]; uid_t __user * auid; char auid_r_[PADR_(uid_t *)];
};
struct getaudit_args {
	char auditinfo_l_[PADL_(struct auditinfo *)]; struct auditinfo __user * auditinfo; char auditinfo_r_[PADR_(struct auditinfo *)];
};
struct setaudit_args {
	char auditinfo_l_[PADL_(struct auditinfo *)]; struct auditinfo __user * auditinfo; char auditinfo_r_[PADR_(struct auditinfo *)];
};
struct getaudit_addr_args {
	char auditinfo_addr_l_[PADL_(struct auditinfo_addr *)]; struct auditinfo_addr __user * auditinfo_addr; char auditinfo_addr_r_[PADR_(struct auditinfo_addr *)];
	char length_l_[PADL_(u_int)]; u_int length; char length_r_[PADR_(u_int)];
};
...
struct _umtx_op_args {
	char obj_l_[PADL_(void *)]; void __user * obj; char obj_r_[PADR_(void *)];
	char op_l_[PADL_(int)]; int op; char op_r_[PADR_(int)];
	char val_l_[PADL_(u_long)]; u_long val; char val_r_[PADR_(u_long)];
	char uaddr1_l_[PADL_(void *)]; void __user * uaddr1; char uaddr1_r_[PADR_(void *)];
	char uaddr2_l_[PADL_(void *)]; void __user * uaddr2; char uaddr2_r_[PADR_(void *)];
};
struct thr_new_args {
	char param_l_[PADL_(struct thr_param *)]; struct thr_param __user * param; char param_r_[PADR_(struct thr_param *)];
	char param_size_l_[PADL_(int)]; int param_size; char param_size_r_[PADR_(int)];
};
struct sigqueue_args {
	char pid_l_[PADL_(pid_t)]; pid_t pid; char pid_r_[PADR_(pid_t)];
	char signum_l_[PADL_(int)]; int signum; char signum_r_[PADR_(int)];
	char value_l_[PADL_(void *)]; void __user * value; char value_r_[PADR_(void *)];
};
struct kmq_open_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char mode_l_[PADL_(mode_t)]; mode_t mode; char mode_r_[PADR_(mode_t)];
	char attr_l_[PADL_(const struct mq_attr *)]; const struct mq_attr __user * attr; char attr_r_[PADR_(const struct mq_attr *)];
};
struct kmq_setattr_args {
	char mqd_l_[PADL_(int)]; int mqd; char mqd_r_[PADR_(int)];
	char attr_l_[PADL_(const struct mq_attr *)]; const struct mq_attr __user * attr; char attr_r_[PADR_(const struct mq_attr *)];
	char oattr_l_[PADL_(struct mq_attr *)]; struct mq_attr __user * oattr; char oattr_r_[PADR_(struct mq_attr *)];
};
struct kmq_timedreceive_args {
	char mqd_l_[PADL_(int)]; int mqd; char mqd_r_[PADR_(int)];
	char msg_ptr_l_[PADL_(char *)]; char __user * msg_ptr; char msg_ptr_r_[PADR_(char *)];
	char msg_len_l_[PADL_(size_t)]; size_t msg_len; char msg_len_r_[PADR_(size_t)];
	char msg_prio_l_[PADL_(unsigned *)]; unsigned __user * msg_prio; char msg_prio_r_[PADR_(unsigned *)];
	char abs_timeout_l_[PADL_(const struct timespec *)]; const struct timespec __user * abs_timeout; char abs_timeout_r_[PADR_(const struct timespec *)];
};
struct kmq_timedsend_args {
	char mqd_l_[PADL_(int)]; int mqd; char mqd_r_[PADR_(int)];
	char msg_ptr_l_[PADL_(const char *)]; const char __user * msg_ptr; char msg_ptr_r_[PADR_(const char *)];
	char msg_len_l_[PADL_(size_t)]; size_t msg_len; char msg_len_r_[PADR_(size_t)];
...
struct kmq_notify_args {
	char mqd_l_[PADL_(int)]; int mqd; char mqd_r_[PADR_(int)];
	char sigev_l_[PADL_(const struct sigevent *)]; const struct sigevent __user * sigev; char sigev_r_[PADR_(const struct sigevent *)];
};
struct kmq_unlink_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
};
struct abort2_args {
	char why_l_[PADL_(const char *)]; const char __user * why; char why_r_[PADR_(const char *)];
	char nargs_l_[PADL_(int)]; int nargs; char nargs_r_[PADR_(int)];
	char args_l_[PADL_(void **)]; void __user * __user * args; char args_r_[PADR_(void **)];
};
...
struct sctp_generic_sendmsg_args {
	char sd_l_[PADL_(int)]; int sd; char sd_r_[PADR_(int)];
	char msg_l_[PADL_(void *)]; void __user * msg; char msg_r_[PADR_(void *)];
	char mlen_l_[PADL_(int)]; int mlen; char mlen_r_[PADR_(int)];
	char to_l_[PADL_(struct sockaddr *)]; struct sockaddr __user * to; char to_r_[PADR_(struct sockaddr *)];
	char tolen_l_[PADL_(__socklen_t)]; __socklen_t tolen; char tolen_r_[PADR_(__socklen_t)];
	char sinfo_l_[PADL_(struct sctp_sndrcvinfo *)]; struct sctp_sndrcvinfo __user * sinfo; char sinfo_r_[PADR_(struct sctp_sndrcvinfo *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct sctp_generic_sendmsg_iov_args {
	char sd_l_[PADL_(int)]; int sd; char sd_r_[PADR_(int)];
	char iov_l_[PADL_(struct iovec *)]; struct iovec __user * iov; char iov_r_[PADR_(struct iovec *)];
...
struct sctp_generic_recvmsg_args {
	...
	char fromlenaddr_l_[PADL_(__socklen_t *)]; __socklen_t __user * fromlenaddr; char fromlenaddr_r_[PADR_(__socklen_t *)];
	char sinfo_l_[PADL_(struct sctp_sndrcvinfo *)]; struct sctp_sndrcvinfo __user * sinfo; char sinfo_r_[PADR_(struct sctp_sndrcvinfo *)];
	char msg_flags_l_[PADL_(int *)]; int __user * msg_flags; char msg_flags_r_[PADR_(int *)];
};
struct pread_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char buf_l_[PADL_(void *)]; void __user * buf; char buf_r_[PADR_(void *)];
...
struct cpuset_args {
	char setid_l_[PADL_(cpusetid_t *)]; cpusetid_t __user * setid; char setid_r_[PADR_(cpusetid_t *)];
};
...
struct cpuset_getaffinity_args {
	...
	char mask_l_[PADL_(cpuset_t *)]; cpuset_t __user * mask; char mask_r_[PADR_(cpuset_t *)];
};
struct cpuset_setaffinity_args {
	...
	char id_l_[PADL_(id_t)]; id_t id; char id_r_[PADR_(id_t)];
	char cpusetsize_l_[PADL_(size_t)]; size_t cpusetsize; char cpusetsize_r_[PADR_(size_t)];
	char mask_l_[PADL_(const cpuset_t *)]; const cpuset_t __user * mask; char mask_r_[PADR_(const cpuset_t *)];
};
...
struct futimesat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char times_l_[PADL_(struct timeval *)]; struct timeval __user * times; char times_r_[PADR_(struct timeval *)];
};
struct linkat_args {
	char fd1_l_[PADL_(int)]; int fd1; char fd1_r_[PADR_(int)];
	char path1_l_[PADL_(const char *)]; const char __user * path1; char path1_r_[PADR_(const char *)];
	char fd2_l_[PADL_(int)]; int fd2; char fd2_r_[PADR_(int)];
	char path2_l_[PADL_(const char *)]; const char __user * path2; char path2_r_[PADR_(const char *)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
struct mkdirat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
...
struct renameat_args {
	...
	char old_l_[PADL_(const char *)]; const char __user * old; char old_r_[PADR_(const char *)];
	char newfd_l_[PADL_(int)]; int newfd; char newfd_r_[PADR_(int)];
	char new_l_[PADL_(const char *)]; const char __user * new; char new_r_[PADR_(const char *)];
};
...
struct __semctl_args {
	...
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char arg_l_[PADL_(union semun *)]; union semun __user * arg; char arg_r_[PADR_(union semun *)];
};
struct msgctl_args {
	char msqid_l_[PADL_(int)]; int msqid; char msqid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct msqid_ds *)]; struct msqid_ds __user * buf; char buf_r_[PADR_(struct msqid_ds *)];
};
struct shmctl_args {
	char shmid_l_[PADL_(int)]; int shmid; char shmid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct shmid_ds *)]; struct shmid_ds __user * buf; char buf_r_[PADR_(struct shmid_ds *)];
};
...
struct __cap_rights_get_args {
	...
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char rightsp_l_[PADL_(cap_rights_t *)]; cap_rights_t __user * rightsp; char rightsp_r_[PADR_(cap_rights_t *)];
};
struct cap_enter_args {
	register_t dummy;
};
struct cap_getmode_args {
	char modep_l_[PADL_(u_int *)]; u_int __user * modep; char modep_r_[PADR_(u_int *)];
};
struct pdfork_args {
	char fdp_l_[PADL_(int *)]; int __user * fdp; char fdp_r_[PADR_(int *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct pdkill_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
...
struct pdgetpid_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char pidp_l_[PADL_(pid_t *)]; pid_t __user * pidp; char pidp_r_[PADR_(pid_t *)];
};
struct pselect_args {
	char nd_l_[PADL_(int)]; int nd; char nd_r_[PADR_(int)];
	char in_l_[PADL_(fd_set *)]; fd_set __user * in; char in_r_[PADR_(fd_set *)];
	char ou_l_[PADL_(fd_set *)]; fd_set __user * ou; char ou_r_[PADR_(fd_set *)];
	char ex_l_[PADL_(fd_set *)]; fd_set __user * ex; char ex_r_[PADR_(fd_set *)];
	char ts_l_[PADL_(const struct timespec *)]; const struct timespec __user * ts; char ts_r_[PADR_(const struct timespec *)];
	char sm_l_[PADL_(const sigset_t *)]; const sigset_t __user * sm; char sm_r_[PADR_(const sigset_t *)];
};
...
struct rctl_get_racct_args {
	char inbufp_l_[PADL_(const void *)]; const void __user * inbufp; char inbufp_r_[PADR_(const void *)];
	char inbuflen_l_[PADL_(size_t)]; size_t inbuflen; char inbuflen_r_[PADR_(size_t)];
	char outbufp_l_[PADL_(void *)]; void __user * outbufp; char outbufp_r_[PADR_(void *)];
...
struct wait6_args {
	...
	char status_l_[PADL_(int *)]; int __user * status; char status_r_[PADR_(int *)];
	char options_l_[PADL_(int)]; int options; char options_r_[PADR_(int)];
	char wrusage_l_[PADL_(struct __wrusage *)]; struct __wrusage __user * wrusage; char wrusage_r_[PADR_(struct __wrusage *)];
	char info_l_[PADL_(siginfo_t *)]; siginfo_t __user * info; char info_r_[PADR_(siginfo_t *)];
};
...
struct cap_ioctls_limit_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char cmds_l_[PADL_(const u_long *)]; const u_long __user * cmds; char cmds_r_[PADR_(const u_long *)];
	char ncmds_l_[PADL_(size_t)]; size_t ncmds; char ncmds_r_[PADR_(size_t)];
};
struct cap_ioctls_get_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char cmds_l_[PADL_(u_long *)]; u_long __user * cmds; char cmds_r_[PADR_(u_long *)];
...
struct cap_fcntls_get_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char fcntlrightsp_l_[PADL_(uint32_t *)]; uint32_t __user * fcntlrightsp; char fcntlrightsp_r_[PADR_(uint32_t *)];
};
struct bindat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
...
struct pipe2_args {
	char fildes_l_[PADL_(int *)]; int __user * fildes; char fildes_r_[PADR_(int *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
...
struct futimens_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char times_l_[PADL_(struct timespec *)]; struct timespec __user * times; char times_r_[PADR_(struct timespec *)];
};
...
struct fstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct stat *)]; struct stat __user * sb; char sb_r_[PADR_(struct stat *)];
};
struct fstatat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char buf_l_[PADL_(struct stat *)]; struct stat __user * buf; char buf_r_[PADR_(struct stat *)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
struct fhstat_args {
	char u_fhp_l_[PADL_(const struct fhandle *)]; const struct fhandle __user * u_fhp; char u_fhp_r_[PADR_(const struct fhandle *)];
...
struct getdirentries_args {
	...
	char buf_l_[PADL_(char *)]; char __user * buf; char buf_r_[PADR_(char *)];
	char count_l_[PADL_(size_t)]; size_t count; char count_r_[PADR_(size_t)];
	char basep_l_[PADL_(off_t *)]; off_t __user * basep; char basep_r_[PADR_(off_t *)];
};
struct statfs_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char buf_l_[PADL_(struct statfs *)]; struct statfs __user * buf; char buf_r_[PADR_(struct statfs *)];
};
struct fstatfs_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char buf_l_[PADL_(struct statfs *)]; struct statfs __user * buf; char buf_r_[PADR_(struct statfs *)];
...
struct kevent_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(struct kevent *)]; struct kevent __user * changelist; char changelist_r_[PADR_(struct kevent *)];
	char nchanges_l_[PADL_(int)]; int nchanges; char nchanges_r_[PADR_(int)];
	char eventlist_l_[PADL_(struct kevent *)]; struct kevent __user * eventlist; char eventlist_r_[PADR_(struct kevent *)];
...
struct cpuset_getdomain_args {
	...
	char mask_l_[PADL_(domainset_t *)]; domainset_t __user * mask; char mask_r_[PADR_(domainset_t *)];
	char policy_l_[PADL_(int *)]; int __user * policy; char policy_r_[PADR_(int *)];
};
...
struct getfhat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char fhp_l_[PADL_(struct fhandle *)]; struct fhandle __user * fhp; char fhp_r_[PADR_(struct fhandle *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct fhlink_args {
...
struct copy_file_range_args {
	...
	char inoffp_l_[PADL_(off_t *)]; off_t __user * inoffp; char inoffp_r_[PADR_(off_t *)];
	char outfd_l_[PADL_(int)]; int outfd; char outfd_r_[PADR_(int)];
	char outoffp_l_[PADL_(off_t *)]; off_t __user * outoffp; char outoffp_r_[PADR_(off_t *)];
	char len_l_[PADL_(size_t)]; size_t len; char len_r_[PADR_(size_t)];
	char flags_l_[PADL_(unsigned int)]; unsigned int flags; char flags_r_[PADR_(unsigned int)];
};
struct __sysctlbyname_args {
	...
	char old_l_[PADL_(void *)]; void __user * old; char old_r_[PADR_(void *)];
	char oldlenp_l_[PADL_(size_t *)]; size_t __user * oldlenp; char oldlenp_r_[PADR_(size_t *)];
	char new_l_[PADL_(void *)]; void __user * new; char new_r_[PADR_(void *)];
	char newlen_l_[PADL_(size_t)]; size_t newlen; char newlen_r_[PADR_(size_t)];
};
...
struct shm_rename_args {
	char path_from_l_[PADL_(const char *)]; const char __user * path_from; char path_from_r_[PADR_(const char *)];
	char path_to_l_[PADL_(const char *)]; const char __user * path_to; char path_to_r_[PADR_(const char *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct sigfastblock_args {
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char ptr_l_[PADL_(uint32_t *)]; uint32_t __user * ptr; char ptr_r_[PADR_(uint32_t *)];
};
...
struct ostat_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct ostat *)]; struct ostat __user * ub; char ub_r_[PADR_(struct ostat *)];
};
struct olstat_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct ostat *)]; struct ostat __user * ub; char ub_r_[PADR_(struct ostat *)];
...
struct osigaction_args {
	char signum_l_[PADL_(int)]; int signum; char signum_r_[PADR_(int)];
	char nsa_l_[PADL_(struct osigaction *)]; struct osigaction __user * nsa; char nsa_r_[PADR_(struct osigaction *)];
	char osa_l_[PADL_(struct osigaction *)]; struct osigaction __user * osa; char osa_r_[PADR_(struct osigaction *)];
};
...
struct ofstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct ostat *)]; struct ostat __user * sb; char sb_r_[PADR_(struct ostat *)];
};
struct ogetkerninfo_args {
	char op_l_[PADL_(int)]; int op; char op_r_[PADR_(int)];
	char where_l_[PADL_(char *)]; char __user * where; char where_r_[PADR_(char *)];
	char size_l_[PADL_(size_t *)]; size_t __user * size; char size_r_[PADR_(size_t *)];
...
struct ogethostname_args {
	char hostname_l_[PADL_(char *)]; char __user * hostname; char hostname_r_[PADR_(char *)];
...
struct oaccept_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char name_l_[PADL_(struct sockaddr *)]; struct sockaddr __user * name; char name_r_[PADR_(struct sockaddr *)];
	char anamelen_l_[PADL_(int *)]; int __user * anamelen; char anamelen_r_[PADR_(int *)];
};
struct osend_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char buf_l_[PADL_(const void *)]; const void __user * buf; char buf_r_[PADR_(const void *)];
...
struct osigreturn_args {
	char sigcntxp_l_[PADL_(struct osigcontext *)]; struct osigcontext __user * sigcntxp; char sigcntxp_r_[PADR_(struct osigcontext *)];
};
struct osigvec_args {
	char signum_l_[PADL_(int)]; int signum; char signum_r_[PADR_(int)];
	char nsv_l_[PADL_(struct sigvec *)]; struct sigvec __user * nsv; char nsv_r_[PADR_(struct sigvec *)];
	char osv_l_[PADL_(struct sigvec *)]; struct sigvec __user * osv; char osv_r_[PADR_(struct sigvec *)];
};
...
struct osigstack_args {
	char nss_l_[PADL_(struct sigstack *)]; struct sigstack __user * nss; char nss_r_[PADR_(struct sigstack *)];
	char oss_l_[PADL_(struct sigstack *)]; struct sigstack __user * oss; char oss_r_[PADR_(struct sigstack *)];
};
struct orecvmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char msg_l_[PADL_(struct omsghdr *)]; struct omsghdr __user * msg; char msg_r_[PADR_(struct omsghdr *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
struct osendmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char msg_l_[PADL_(const void *)]; const void __user * msg; char msg_r_[PADR_(const void *)];
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
};
...
struct ogetpeername_args {
	char fdes_l_[PADL_(int)]; int fdes; char fdes_r_[PADR_(int)];
	char asa_l_[PADL_(struct sockaddr *)]; struct sockaddr __user * asa; char asa_r_[PADR_(struct sockaddr *)];
	char alen_l_[PADL_(int *)]; int __user * alen; char alen_r_[PADR_(int *)];
};
...
struct ogetrlimit_args {
	char which_l_[PADL_(u_int)]; u_int which; char which_r_[PADR_(u_int)];
	char rlp_l_[PADL_(struct orlimit *)]; struct orlimit __user * rlp; char rlp_r_[PADR_(struct orlimit *)];
};
...
struct ogetdirentries_args {
	...
	char basep_l_[PADL_(long *)]; long __user * basep; char basep_r_[PADR_(long *)];
};
...
struct freebsd4_getfsstat_args {
	char buf_l_[PADL_(struct ostatfs *)]; struct ostatfs __user * buf; char buf_r_[PADR_(struct ostatfs *)];
	char bufsize_l_[PADL_(long)]; long bufsize; char bufsize_r_[PADR_(long)];
	char mode_l_[PADL_(int)]; int mode; char mode_r_[PADR_(int)];
};
...
struct freebsd4_getdomainname_args {
	char domainname_l_[PADL_(char *)]; char __user * domainname; char domainname_r_[PADR_(char *)];
	char len_l_[PADL_(int)]; int len; char len_r_[PADR_(int)];
};
...
struct freebsd4_uname_args {
	char name_l_[PADL_(struct utsname *)]; struct utsname __user * name; char name_r_[PADR_(struct utsname *)];
};
...
struct freebsd4_sigreturn_args {
	char sigcntxp_l_[PADL_(const struct ucontext4 *)]; const struct ucontext4 __user * sigcntxp; char sigcntxp_r_[PADR_(const struct ucontext4 *)];
};
...
struct freebsd6_aio_read_args {
	char aiocbp_l_[PADL_(struct oaiocb *)]; struct oaiocb __user * aiocbp; char aiocbp_r_[PADR_(struct oaiocb *)];
};
...
struct freebsd6_lio_listio_args {
	char mode_l_[PADL_(int)]; int mode; char mode_r_[PADR_(int)];
	char acb_list_l_[PADL_(struct oaiocb * const *)]; struct oaiocb __user * const __user * acb_list; char acb_list_r_[PADR_(struct oaiocb * const *)];
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char sig_l_[PADL_(struct osigevent *)]; struct osigevent __user * sig; char sig_r_[PADR_(struct osigevent *)];
};
...
struct freebsd7___semctl_args {
	...
	char semnum_l_[PADL_(int)]; int semnum; char semnum_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char arg_l_[PADL_(union semun_old *)]; union semun_old __user * arg; char arg_r_[PADR_(union semun_old *)];
};
struct freebsd7_msgctl_args {
	char msqid_l_[PADL_(int)]; int msqid; char msqid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct msqid_ds_old *)]; struct msqid_ds_old __user * buf; char buf_r_[PADR_(struct msqid_ds_old *)];
};
struct freebsd7_shmctl_args {
	char shmid_l_[PADL_(int)]; int shmid; char shmid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct shmid_ds_old *)]; struct shmid_ds_old __user * buf; char buf_r_[PADR_(struct shmid_ds_old *)];
};
...
struct freebsd11_stat_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct freebsd11_stat *)]; struct freebsd11_stat __user * ub; char ub_r_[PADR_(struct freebsd11_stat *)];
};
struct freebsd11_fstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct freebsd11_stat *)]; struct freebsd11_stat __user * sb; char sb_r_[PADR_(struct freebsd11_stat *)];
};
...
struct freebsd11_nstat_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct nstat *)]; struct nstat __user * ub; char ub_r_[PADR_(struct nstat *)];
};
struct freebsd11_nfstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct nstat *)]; struct nstat __user * sb; char sb_r_[PADR_(struct nstat *)];
};
...
struct freebsd11_kevent_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(struct kevent_freebsd11 *)]; struct kevent_freebsd11 __user * changelist; char changelist_r_[PADR_(struct kevent_freebsd11 *)];
	char nchanges_l_[PADL_(int)]; int nchanges; char nchanges_r_[PADR_(int)];
	char eventlist_l_[PADL_(struct kevent_freebsd11 *)]; struct kevent_freebsd11 __user * eventlist; char eventlist_r_[PADR_(struct kevent_freebsd11 *)];
	char nevents_l_[PADL_(int)]; int nevents; char nevents_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct timespec *)]; const struct timespec __user * timeout; char timeout_r_[PADR_(const struct timespec *)];
};
struct freebsd11_getfsstat_args {
	char buf_l_[PADL_(struct freebsd11_statfs *)]; struct freebsd11_statfs __user * buf; char buf_r_[PADR_(struct freebsd11_statfs *)];
	char bufsize_l_[PADL_(long)]; long bufsize; char bufsize_r_[PADR_(long)];
	char mode_l_[PADL_(int)]; int mode; char mode_r_[PADR_(int)];
};
...
struct freebsd11_fstatat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char buf_l_[PADL_(struct freebsd11_stat *)]; struct freebsd11_stat __user * buf; char buf_r_[PADR_(struct freebsd11_stat *)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
