...
struct linux_pipe_args {
	char pipefds_l_[PADL_(l_ulong *)]; l_ulong __user * pipefds; char pipefds_r_[PADR_(l_ulong *)];
};
...
struct linux_set_tid_address_args {
	char tidptr_l_[PADL_(l_int *)]; l_int __user * tidptr; char tidptr_r_[PADR_(l_int *)];
};
...
struct linux_kexec_file_load_args {
	...
	char cmdline_ptr_l_[PADL_(const char *)]; const char __user * cmdline_ptr; char cmdline_ptr_r_[PADR_(const char *)];
	char flags_l_[PADL_(l_ulong)]; l_ulong flags; char flags_r_[PADR_(l_ulong)];
};
