...
struct linux_execve_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char argp_l_[PADL_(uint32_t *)]; uint32_t __user * argp; char argp_r_[PADR_(uint32_t *)];
	char envp_l_[PADL_(uint32_t *)]; uint32_t __user * envp; char envp_r_[PADR_(uint32_t *)];
};
...
struct linux_getrusage_args {
	...
	char rusage_l_[PADL_(struct l_rusage *)]; struct l_rusage __user * rusage; char rusage_r_[PADR_(struct l_rusage *)];
};
struct linux_gettimeofday_args {
	char tp_l_[PADL_(struct l_timeval *)]; struct l_timeval __user * tp; char tp_r_[PADR_(struct l_timeval *)];
...
struct linux_lstat_args {
	char path_l_[PADL_(char *)]; char __user * path; char path_r_[PADR_(char *)];
	char up_l_[PADL_(struct linux_lstat *)]; struct linux_lstat __user * up; char up_r_[PADR_(struct linux_lstat *)];
};
...
struct linux_readv_args {
	...
	char iovp_l_[PADL_(struct l_iovec32 *)]; struct l_iovec32 __user * iovp; char iovp_r_[PADR_(struct l_iovec32 *)];
