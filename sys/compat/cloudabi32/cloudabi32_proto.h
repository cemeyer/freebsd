...
struct cloudabi_sys_condvar_signal_args {
	char condvar_l_[PADL_(cloudabi_condvar_t *)]; cloudabi_condvar_t __user * condvar; char condvar_r_[PADR_(cloudabi_condvar_t *)];
...
struct cloudabi32_sys_fd_pread_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char iovs_l_[PADL_(const cloudabi32_iovec_t *)]; const cloudabi32_iovec_t __user * iovs; char iovs_r_[PADR_(const cloudabi32_iovec_t *)];
...
struct cloudabi32_sys_fd_pwrite_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char iovs_l_[PADL_(const cloudabi32_ciovec_t *)]; const cloudabi32_ciovec_t __user * iovs; char iovs_r_[PADR_(const cloudabi32_ciovec_t *)];
	char iovs_len_l_[PADL_(size_t)]; size_t iovs_len; char iovs_len_r_[PADR_(size_t)];
	char offset_l_[PADL_(cloudabi_filesize_t)]; cloudabi_filesize_t offset; char offset_r_[PADR_(cloudabi_filesize_t)];
};
...
struct cloudabi_sys_fd_stat_get_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char buf_l_[PADL_(cloudabi_fdstat_t *)]; cloudabi_fdstat_t __user * buf; char buf_r_[PADR_(cloudabi_fdstat_t *)];
};
struct cloudabi_sys_fd_stat_put_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char buf_l_[PADL_(const cloudabi_fdstat_t *)]; const cloudabi_fdstat_t __user * buf; char buf_r_[PADR_(const cloudabi_fdstat_t *)];
...
struct cloudabi_sys_file_open_args {
	...
	char fds_l_[PADL_(const cloudabi_fdstat_t *)]; const cloudabi_fdstat_t __user * fds; char fds_r_[PADR_(const cloudabi_fdstat_t *)];
};
...
struct cloudabi_sys_file_stat_fget_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char buf_l_[PADL_(cloudabi_filestat_t *)]; cloudabi_filestat_t __user * buf; char buf_r_[PADR_(cloudabi_filestat_t *)];
};
struct cloudabi_sys_file_stat_fput_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char buf_l_[PADL_(const cloudabi_filestat_t *)]; const cloudabi_filestat_t __user * buf; char buf_r_[PADR_(const cloudabi_filestat_t *)];
...
struct cloudabi_sys_lock_unlock_args {
	char lock_l_[PADL_(cloudabi_lock_t *)]; cloudabi_lock_t __user * lock; char lock_r_[PADR_(cloudabi_lock_t *)];
	char scope_l_[PADL_(cloudabi_scope_t)]; cloudabi_scope_t scope; char scope_r_[PADR_(cloudabi_scope_t)];
};
struct cloudabi_sys_mem_advise_args {
	char mapping_l_[PADL_(void *)]; void __user * mapping; char mapping_r_[PADR_(void *)];
...
struct cloudabi32_sys_poll_args {
	char in_l_[PADL_(const cloudabi32_subscription_t *)]; const cloudabi32_subscription_t __user * in; char in_r_[PADR_(const cloudabi32_subscription_t *)];
	char out_l_[PADL_(cloudabi_event_t *)]; cloudabi_event_t __user * out; char out_r_[PADR_(cloudabi_event_t *)];
...
struct cloudabi_sys_proc_exec_args {
	char fd_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t fd; char fd_r_[PADR_(cloudabi_fd_t)];
	char data_l_[PADL_(const void *)]; const void __user * data; char data_r_[PADR_(const void *)];
	char data_len_l_[PADL_(size_t)]; size_t data_len; char data_len_r_[PADR_(size_t)];
	char fds_l_[PADL_(const cloudabi_fd_t *)]; const cloudabi_fd_t __user * fds; char fds_r_[PADR_(const cloudabi_fd_t *)];
...
struct cloudabi32_sys_sock_recv_args {
	...
	char in_l_[PADL_(const cloudabi32_recv_in_t *)]; const cloudabi32_recv_in_t __user * in; char in_r_[PADR_(const cloudabi32_recv_in_t *)];
	char out_l_[PADL_(cloudabi32_recv_out_t *)]; cloudabi32_recv_out_t __user * out; char out_r_[PADR_(cloudabi32_recv_out_t *)];
};
struct cloudabi32_sys_sock_send_args {
	char sock_l_[PADL_(cloudabi_fd_t)]; cloudabi_fd_t sock; char sock_r_[PADR_(cloudabi_fd_t)];
	char in_l_[PADL_(const cloudabi32_send_in_t *)]; const cloudabi32_send_in_t __user * in; char in_r_[PADR_(const cloudabi32_send_in_t *)];
	char out_l_[PADL_(cloudabi32_send_out_t *)]; cloudabi32_send_out_t __user * out; char out_r_[PADR_(cloudabi32_send_out_t *)];
};
...
struct cloudabi32_sys_thread_create_args {
	char attr_l_[PADL_(cloudabi32_threadattr_t *)]; cloudabi32_threadattr_t __user * attr; char attr_r_[PADR_(cloudabi32_threadattr_t *)];
};
