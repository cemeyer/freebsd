...
struct freebsd32_wait4_args {
	...
	char rusage_l_[PADL_(struct rusage32 *)]; struct rusage32 __user * rusage; char rusage_r_[PADR_(struct rusage32 *)];
};
struct freebsd32_recvmsg_args {
	char s_l_[PADL_(int)]; int s; char s_r_[PADR_(int)];
	char msg_l_[PADL_(struct msghdr32 *)]; struct msghdr32 __user * msg; char msg_r_[PADR_(struct msghdr32 *)];
...
struct freebsd32_sigaltstack_args {
	char ss_l_[PADL_(struct sigaltstack32 *)]; struct sigaltstack32 __user * ss; char ss_r_[PADR_(struct sigaltstack32 *)];
	char oss_l_[PADL_(struct sigaltstack32 *)]; struct sigaltstack32 __user * oss; char oss_r_[PADR_(struct sigaltstack32 *)];
};
struct freebsd32_ioctl_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char com_l_[PADL_(uint32_t)]; uint32_t com; char com_r_[PADR_(uint32_t)];
	char data_l_[PADL_(struct md_ioctl32 *)]; struct md_ioctl32 __user * data; char data_r_[PADR_(struct md_ioctl32 *)];
};
struct freebsd32_execve_args {
	char fname_l_[PADL_(const char *)]; const char __user * fname; char fname_r_[PADR_(const char *)];
	char argv_l_[PADL_(uint32_t *)]; uint32_t __user * argv; char argv_r_[PADR_(uint32_t *)];
	char envv_l_[PADL_(uint32_t *)]; uint32_t __user * envv; char envv_r_[PADR_(uint32_t *)];
};
...
struct freebsd32_setitimer_args {
	...
	char itv_l_[PADL_(struct itimerval32 *)]; struct itimerval32 __user * itv; char itv_r_[PADR_(struct itimerval32 *)];
	char oitv_l_[PADL_(struct itimerval32 *)]; struct itimerval32 __user * oitv; char oitv_r_[PADR_(struct itimerval32 *)];
};
...
struct freebsd32_select_args {
	...
	char tv_l_[PADL_(struct timeval32 *)]; struct timeval32 __user * tv; char tv_r_[PADR_(struct timeval32 *)];
};
struct freebsd32_gettimeofday_args {
	char tp_l_[PADL_(struct timeval32 *)]; struct timeval32 __user * tp; char tp_r_[PADR_(struct timeval32 *)];
...
struct freebsd32_readv_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char iovp_l_[PADL_(struct iovec32 *)]; struct iovec32 __user * iovp; char iovp_r_[PADR_(struct iovec32 *)];
...
struct freebsd32_utimes_args {
	...
	char tptr_l_[PADL_(struct timeval32 *)]; struct timeval32 __user * tptr; char tptr_r_[PADR_(struct timeval32 *)];
};
struct freebsd32_adjtime_args {
	char delta_l_[PADL_(struct timeval32 *)]; struct timeval32 __user * delta; char delta_r_[PADR_(struct timeval32 *)];
	char olddelta_l_[PADL_(struct timeval32 *)]; struct timeval32 __user * olddelta; char olddelta_r_[PADR_(struct timeval32 *)];
};
...
struct freebsd32___sysctl_args {
	...
	char oldlenp_l_[PADL_(uint32_t *)]; uint32_t __user * oldlenp; char oldlenp_r_[PADR_(uint32_t *)];
...
struct freebsd32_clock_gettime_args {
	...
	char tp_l_[PADL_(struct timespec32 *)]; struct timespec32 __user * tp; char tp_r_[PADR_(struct timespec32 *)];
};
struct freebsd32_clock_settime_args {
	char clock_id_l_[PADL_(clockid_t)]; clockid_t clock_id; char clock_id_r_[PADR_(clockid_t)];
	char tp_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * tp; char tp_r_[PADR_(const struct timespec32 *)];
};
...
struct freebsd32_ktimer_create_args {
	char clock_id_l_[PADL_(clockid_t)]; clockid_t clock_id; char clock_id_r_[PADR_(clockid_t)];
	char evp_l_[PADL_(struct sigevent32 *)]; struct sigevent32 __user * evp; char evp_r_[PADR_(struct sigevent32 *)];
...
struct freebsd32_ktimer_settime_args {
	...
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char value_l_[PADL_(const struct itimerspec32 *)]; const struct itimerspec32 __user * value; char value_r_[PADR_(const struct itimerspec32 *)];
	char ovalue_l_[PADL_(struct itimerspec32 *)]; struct itimerspec32 __user * ovalue; char ovalue_r_[PADR_(struct itimerspec32 *)];
};
struct freebsd32_ktimer_gettime_args {
	char timerid_l_[PADL_(int)]; int timerid; char timerid_r_[PADR_(int)];
	char value_l_[PADL_(struct itimerspec32 *)]; struct itimerspec32 __user * value; char value_r_[PADR_(struct itimerspec32 *)];
};
struct freebsd32_nanosleep_args {
	char rqtp_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * rqtp; char rqtp_r_[PADR_(const struct timespec32 *)];
	char rmtp_l_[PADL_(struct timespec32 *)]; struct timespec32 __user * rmtp; char rmtp_r_[PADR_(struct timespec32 *)];
};
...
struct freebsd32_aio_read_args {
	char aiocbp_l_[PADL_(struct aiocb32 *)]; struct aiocb32 __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb32 *)];
};
...
struct freebsd32_lio_listio_args {
	...
	char acb_list_l_[PADL_(struct aiocb32 * const *)]; struct aiocb32 __user * const __user * acb_list; char acb_list_r_[PADR_(struct aiocb32 * const *)];
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char sig_l_[PADL_(struct sigevent32 *)]; struct sigevent32 __user * sig; char sig_r_[PADR_(struct sigevent32 *)];
};
...
struct freebsd32_modstat_args {
	...
	char stat_l_[PADL_(struct module_stat32 *)]; struct module_stat32 __user * stat; char stat_r_[PADR_(struct module_stat32 *)];
};
struct freebsd32_kldstat_args {
	char fileid_l_[PADL_(int)]; int fileid; char fileid_r_[PADR_(int)];
	char stat_l_[PADL_(struct kld32_file_stat *)]; struct kld32_file_stat __user * stat; char stat_r_[PADR_(struct kld32_file_stat *)];
};
struct freebsd32_aio_return_args {
	char aiocbp_l_[PADL_(struct aiocb32 *)]; struct aiocb32 __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb32 *)];
};
struct freebsd32_aio_suspend_args {
	char aiocbp_l_[PADL_(struct aiocb32 * const *)]; struct aiocb32 __user * const __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb32 * const *)];
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * timeout; char timeout_r_[PADR_(const struct timespec32 *)];
};
...
struct freebsd32_sched_rr_get_interval_args {
	...
	char interval_l_[PADL_(struct timespec32 *)]; struct timespec32 __user * interval; char interval_r_[PADR_(struct timespec32 *)];
};
struct freebsd32_jail_args {
	char jail_l_[PADL_(struct jail32 *)]; struct jail32 __user * jail; char jail_r_[PADR_(struct jail32 *)];
};
...
struct freebsd32_aio_waitcomplete_args {
	char aiocbp_l_[PADL_(struct aiocb32 **)]; struct aiocb32 __user * __user * aiocbp; char aiocbp_r_[PADR_(struct aiocb32 **)];
	char timeout_l_[PADL_(struct timespec32 *)]; struct timespec32 __user * timeout; char timeout_r_[PADR_(struct timespec32 *)];
};
...
struct freebsd32_sendfile_args {
	...
	char hdtr_l_[PADL_(struct sf_hdtr32 *)]; struct sf_hdtr32 __user * hdtr; char hdtr_r_[PADR_(struct sf_hdtr32 *)];
...
struct freebsd32_sigaction_args {
	...
	char act_l_[PADL_(struct sigaction32 *)]; struct sigaction32 __user * act; char act_r_[PADR_(struct sigaction32 *)];
	char oact_l_[PADL_(struct sigaction32 *)]; struct sigaction32 __user * oact; char oact_r_[PADR_(struct sigaction32 *)];
};
struct freebsd32_sigreturn_args {
	char sigcntxp_l_[PADL_(const struct freebsd32_ucontext *)]; const struct freebsd32_ucontext __user * sigcntxp; char sigcntxp_r_[PADR_(const struct freebsd32_ucontext *)];
};
struct freebsd32_getcontext_args {
	char ucp_l_[PADL_(struct freebsd32_ucontext *)]; struct freebsd32_ucontext __user * ucp; char ucp_r_[PADR_(struct freebsd32_ucontext *)];
};
struct freebsd32_setcontext_args {
	char ucp_l_[PADL_(const struct freebsd32_ucontext *)]; const struct freebsd32_ucontext __user * ucp; char ucp_r_[PADR_(const struct freebsd32_ucontext *)];
};
struct freebsd32_swapcontext_args {
	char oucp_l_[PADL_(struct freebsd32_ucontext *)]; struct freebsd32_ucontext __user * oucp; char oucp_r_[PADR_(struct freebsd32_ucontext *)];
	char ucp_l_[PADL_(const struct freebsd32_ucontext *)]; const struct freebsd32_ucontext __user * ucp; char ucp_r_[PADR_(const struct freebsd32_ucontext *)];
};
struct freebsd32_ksem_timedwait_args {
	char id_l_[PADL_(semid_t)]; semid_t id; char id_r_[PADR_(semid_t)];
	char abstime_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * abstime; char abstime_r_[PADR_(const struct timespec32 *)];
};
...
struct freebsd32_thr_new_args {
	char param_l_[PADL_(struct thr_param32 *)]; struct thr_param32 __user * param; char param_r_[PADR_(struct thr_param32 *)];
...
struct freebsd32_kmq_open_args {
	...
	char flags_l_[PADL_(int)]; int flags; char flags_r_[PADR_(int)];
	char mode_l_[PADL_(mode_t)]; mode_t mode; char mode_r_[PADR_(mode_t)];
	char attr_l_[PADL_(const struct mq_attr32 *)]; const struct mq_attr32 __user * attr; char attr_r_[PADR_(const struct mq_attr32 *)];
};
struct freebsd32_kmq_setattr_args {
	char mqd_l_[PADL_(int)]; int mqd; char mqd_r_[PADR_(int)];
	char attr_l_[PADL_(const struct mq_attr32 *)]; const struct mq_attr32 __user * attr; char attr_r_[PADR_(const struct mq_attr32 *)];
	char oattr_l_[PADL_(struct mq_attr32 *)]; struct mq_attr32 __user * oattr; char oattr_r_[PADR_(struct mq_attr32 *)];
};
struct freebsd32_kmq_timedreceive_args {
	...
	char abs_timeout_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * abs_timeout; char abs_timeout_r_[PADR_(const struct timespec32 *)];
};
...
struct freebsd32_kmq_notify_args {
	char mqd_l_[PADL_(int)]; int mqd; char mqd_r_[PADR_(int)];
	char sigev_l_[PADL_(const struct sigevent32 *)]; const struct sigevent32 __user * sigev; char sigev_r_[PADR_(const struct sigevent32 *)];
};
...
struct freebsd32_semctl_args {
	...
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char arg_l_[PADL_(union semun32 *)]; union semun32 __user * arg; char arg_r_[PADR_(union semun32 *)];
};
struct freebsd32_msgctl_args {
	char msqid_l_[PADL_(int)]; int msqid; char msqid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct msqid_ds32 *)]; struct msqid_ds32 __user * buf; char buf_r_[PADR_(struct msqid_ds32 *)];
};
struct freebsd32_shmctl_args {
	char shmid_l_[PADL_(int)]; int shmid; char shmid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct shmid_ds32 *)]; struct shmid_ds32 __user * buf; char buf_r_[PADR_(struct shmid_ds32 *)];
};
struct freebsd32_pselect_args {
	...
	char ou_l_[PADL_(fd_set *)]; fd_set __user * ou; char ou_r_[PADR_(fd_set *)];
	char ex_l_[PADL_(fd_set *)]; fd_set __user * ex; char ex_r_[PADR_(fd_set *)];
	char ts_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * ts; char ts_r_[PADR_(const struct timespec32 *)];
...
struct freebsd32_wait6_args {
	...
	char status_l_[PADL_(int *)]; int __user * status; char status_r_[PADR_(int *)];
	char options_l_[PADL_(int)]; int options; char options_r_[PADR_(int)];
	char wrusage_l_[PADL_(struct wrusage32 *)]; struct wrusage32 __user * wrusage; char wrusage_r_[PADR_(struct wrusage32 *)];
	char info_l_[PADL_(siginfo_t *)]; siginfo_t __user * info; char info_r_[PADR_(siginfo_t *)];
};
#else
struct freebsd32_posix_fallocate_args {
...
struct freebsd32_cap_ioctls_limit_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char cmds_l_[PADL_(const uint32_t *)]; const uint32_t __user * cmds; char cmds_r_[PADR_(const uint32_t *)];
	char ncmds_l_[PADL_(size_t)]; size_t ncmds; char ncmds_r_[PADR_(size_t)];
};
struct freebsd32_cap_ioctls_get_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char cmds_l_[PADL_(uint32_t *)]; uint32_t __user * cmds; char cmds_r_[PADR_(uint32_t *)];
...
struct freebsd32_fstat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char ub_l_[PADL_(struct stat32 *)]; struct stat32 __user * ub; char ub_r_[PADR_(struct stat32 *)];
};
struct freebsd32_fstatat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char buf_l_[PADL_(struct stat32 *)]; struct stat32 __user * buf; char buf_r_[PADR_(struct stat32 *)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
struct freebsd32_fhstat_args {
	...
	char sb_l_[PADL_(struct stat32 *)]; struct stat32 __user * sb; char sb_r_[PADR_(struct stat32 *)];
};
#ifdef PAD64_REQUIRED
...
struct freebsd32_kevent_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(const struct kevent32 *)]; const struct kevent32 __user * changelist; char changelist_r_[PADR_(const struct kevent32 *)];
	char nchanges_l_[PADL_(int)]; int nchanges; char nchanges_r_[PADR_(int)];
	char eventlist_l_[PADL_(struct kevent32 *)]; struct kevent32 __user * eventlist; char eventlist_r_[PADR_(struct kevent32 *)];
...
struct ofreebsd32_stat_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct ostat32 *)]; struct ostat32 __user * ub; char ub_r_[PADR_(struct ostat32 *)];
};
...
struct ofreebsd32_sigaction_args {
	char signum_l_[PADL_(int)]; int signum; char signum_r_[PADR_(int)];
	char nsa_l_[PADL_(struct osigaction32 *)]; struct osigaction32 __user * nsa; char nsa_r_[PADR_(struct osigaction32 *)];
	char osa_l_[PADL_(struct osigaction32 *)]; struct osigaction32 __user * osa; char osa_r_[PADR_(struct osigaction32 *)];
};
...
struct ofreebsd32_sigreturn_args {
	char sigcntxp_l_[PADL_(struct ia32_sigcontext3 *)]; struct ia32_sigcontext3 __user * sigcntxp; char sigcntxp_r_[PADR_(struct ia32_sigcontext3 *)];
};
struct ofreebsd32_sigvec_args {
	char signum_l_[PADL_(int)]; int signum; char signum_r_[PADR_(int)];
	char nsv_l_[PADL_(struct sigvec32 *)]; struct sigvec32 __user * nsv; char nsv_r_[PADR_(struct sigvec32 *)];
	char osv_l_[PADL_(struct sigvec32 *)]; struct sigvec32 __user * osv; char osv_r_[PADR_(struct sigvec32 *)];
};
...
struct ofreebsd32_sigstack_args {
	char nss_l_[PADL_(struct sigstack32 *)]; struct sigstack32 __user * nss; char nss_r_[PADR_(struct sigstack32 *)];
	char oss_l_[PADL_(struct sigstack32 *)]; struct sigstack32 __user * oss; char oss_r_[PADR_(struct sigstack32 *)];
};
struct ofreebsd32_getdirentries_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char buf_l_[PADL_(char *)]; char __user * buf; char buf_r_[PADR_(char *)];
	char count_l_[PADL_(u_int)]; u_int count; char count_r_[PADR_(u_int)];
	char basep_l_[PADL_(uint32_t *)]; uint32_t __user * basep; char basep_r_[PADR_(uint32_t *)];
};
#ifdef PAD64_REQUIRED
#else
#endif
...
struct freebsd4_freebsd32_getfsstat_args {
	char buf_l_[PADL_(struct statfs32 *)]; struct statfs32 __user * buf; char buf_r_[PADR_(struct statfs32 *)];
...
struct freebsd4_freebsd32_sigreturn_args {
	char sigcntxp_l_[PADL_(const struct freebsd4_freebsd32_ucontext *)]; const struct freebsd4_freebsd32_ucontext __user * sigcntxp; char sigcntxp_r_[PADR_(const struct freebsd4_freebsd32_ucontext *)];
};
#ifdef PAD64_REQUIRED
#else
#endif
...
struct freebsd6_freebsd32_aio_read_args {
	char aiocbp_l_[PADL_(struct oaiocb32 *)]; struct oaiocb32 __user * aiocbp; char aiocbp_r_[PADR_(struct oaiocb32 *)];
};
...
struct freebsd6_freebsd32_lio_listio_args {
	char mode_l_[PADL_(int)]; int mode; char mode_r_[PADR_(int)];
	char acb_list_l_[PADL_(struct oaiocb32 * const *)]; struct oaiocb32 __user * const __user * acb_list; char acb_list_r_[PADR_(struct oaiocb32 * const *)];
	char nent_l_[PADL_(int)]; int nent; char nent_r_[PADR_(int)];
	char sig_l_[PADL_(struct osigevent32 *)]; struct osigevent32 __user * sig; char sig_r_[PADR_(struct osigevent32 *)];
};
#ifdef PAD64_REQUIRED
#else
#endif
...
struct freebsd7_freebsd32_msgctl_args {
	char msqid_l_[PADL_(int)]; int msqid; char msqid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct msqid_ds32_old *)]; struct msqid_ds32_old __user * buf; char buf_r_[PADR_(struct msqid_ds32_old *)];
};
struct freebsd7_freebsd32_shmctl_args {
	char shmid_l_[PADL_(int)]; int shmid; char shmid_r_[PADR_(int)];
	char cmd_l_[PADL_(int)]; int cmd; char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct shmid_ds32_old *)]; struct shmid_ds32_old __user * buf; char buf_r_[PADR_(struct shmid_ds32_old *)];
};
#ifdef PAD64_REQUIRED
#else
#endif
...
struct freebsd11_freebsd32_stat_args {
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct freebsd11_stat32 *)]; struct freebsd11_stat32 __user * ub; char ub_r_[PADR_(struct freebsd11_stat32 *)];
};
...
struct freebsd11_freebsd32_getdirentries_args {
	...
	char buf_l_[PADL_(char *)]; char __user * buf; char buf_r_[PADR_(char *)];
	char count_l_[PADL_(u_int)]; u_int count; char count_r_[PADR_(u_int)];
	char basep_l_[PADL_(int32_t *)]; int32_t __user * basep; char basep_r_[PADR_(int32_t *)];
};
...
struct freebsd11_freebsd32_fhstat_args {
	char u_fhp_l_[PADL_(const struct fhandle *)]; const struct fhandle __user * u_fhp; char u_fhp_r_[PADR_(const struct fhandle *)];
	char sb_l_[PADL_(struct freebsd11_stat32 *)]; struct freebsd11_stat32 __user * sb; char sb_r_[PADR_(struct freebsd11_stat32 *)];
};
struct freebsd11_freebsd32_kevent_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(const struct kevent32_freebsd11 *)]; const struct kevent32_freebsd11 __user * changelist; char changelist_r_[PADR_(const struct kevent32_freebsd11 *)];
	char nchanges_l_[PADL_(int)]; int nchanges; char nchanges_r_[PADR_(int)];
	char eventlist_l_[PADL_(struct kevent32_freebsd11 *)]; struct kevent32_freebsd11 __user * eventlist; char eventlist_r_[PADR_(struct kevent32_freebsd11 *)];
	char nevents_l_[PADL_(int)]; int nevents; char nevents_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct timespec32 *)]; const struct timespec32 __user * timeout; char timeout_r_[PADR_(const struct timespec32 *)];
};
#ifdef PAD64_REQUIRED
...
struct freebsd11_freebsd32_fstatat_args {
	char fd_l_[PADL_(int)]; int fd; char fd_r_[PADR_(int)];
	char path_l_[PADL_(const char *)]; const char __user * path; char path_r_[PADR_(const char *)];
	char buf_l_[PADL_(struct freebsd11_stat32 *)]; struct freebsd11_stat32 __user * buf; char buf_r_[PADR_(struct freebsd11_stat32 *)];
	char flag_l_[PADL_(int)]; int flag; char flag_r_[PADR_(int)];
};
#ifdef PAD64_REQUIRED
#else
